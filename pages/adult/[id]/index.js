  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${adultzipItem.name} | 123 Movies???`,
      ...
      },
      {
        ...
        headline: ` ${adultzipItem.name} | 123 Movies???`,
        datePublished: adultzipItem.datePublished,
        dateModified: adultzipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {adultzipItem.name} | 123 Movies???</title>
        ...
        <meta
          property='og:title'
          content={`${adultzipItem && adultzipItem.name} - 123 Movies???`}
        />
        <meta
          property='og:description'
          content='Stream HD adultzipItems and TV series for free on 123 Movies???. Online. Stream. Download. full-length adultzipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${adultzipItem.title} available on 123 Movies???. Enjoy free streaming of full-length adultzipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
