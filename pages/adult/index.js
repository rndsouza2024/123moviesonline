...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online Adult Content | 123Movies™',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Adult',
      item: 'https://123moviesonline.vercel.app/adult/'
    }
  ]
})
...
const adultPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Adult Content | 123Movies™</title>
        ...
        <meta property='og:title' content=' Watch Online Adult |   123Movies Online™' />
      ...
      >
        123Movies Online™ - Adult Section.
      </h1>
