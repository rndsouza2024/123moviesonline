...
const AdultPage = ({ adults }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'http://localhost:3000/addult/#website',
        url: 'http://localhost:3000/adult',
        name: '123Movies Online™ - Explore. Stream. Online. ',
        publisher: {
          '@type': 'Organization',
          '@id': 'http://localhost:3000/#organization'
      ...
      {
        '@type': 'WebPage',
        '@id': 'http://localhost:3000/adult/#webpage',
        url: 'http://localhost:3000/adult',
        name: 'Movie',
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        />
        <link rel='canonical' href='http://localhost:3000/adult' />
        ...
        />z
        <meta property='og:url' content='http://localhost:3000/adult' />
        <meta
