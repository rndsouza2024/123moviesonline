...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Ang Kapitbahay (2024) | 123Movies™',
    alternateName: [
      'Ver película Ang Kapitbahay (2024) | 123Movies™',
      'Regarder le film Ang Kapitbahay (2024) | 123Movies™',
      'Film Ang Kapitbahay (2024) ansehen | 123Movies™',
      '观看电影 Ang Kapitbahay (2024) | 123Movies™',
      '映画 Ang Kapitbahay (2024) を見る | 123Movies™',
      '영화 Ang Kapitbahay (2024) 보기 | 123Movies™',
      'Assistir Filme Ang Kapitbahay (2024) | 123Movies™',
      'Guarda il film Ang Kapitbahay (2024) | 123Movies™',
      'Посмотреть фильм Ang Kapitbahay (2024) | 123Movies™',
      'مشاهدة فيلم Ang Kapitbahay (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Ang Kapitbahay (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-ang-kapitbahay-2024'
  )
  return {
    props: {
      movie: selectedMovie
