...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Ang Pintor At Ang Paraluman (2024) | 123Movies™',
    alternateName: [
      'Ver película Ang Pintor At Ang Paraluman (2024) | 123Movies™',
      'Regarder le film Ang Pintor At Ang Paraluman (2024) | 123Movies™',
      'Film Ang Pintor At Ang Paraluman (2024) ansehen | 123Movies™',
      '观看电影 Ang Pintor At Ang Paraluman (2024) | 123Movies™',
      '映画 Ang Pintor At Ang Paraluman (2024) を見る | 123Movies™',
      '영화 Ang Pintor At Ang Paraluman (2024) 보기 | 123Movies™',
      'Assistir Filme Ang Pintor At Ang Paraluman (2024) | 123Movies™',
      'Guarda il film Ang Pintor At Ang Paraluman (2024) | 123Movies™',
      'Посмотреть фильм Ang Pintor At Ang Paraluman (2024) | 123Movies™',
      'مشاهدة فيلم Ang Pintor At Ang Paraluman (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Ang Pintor At Ang Paraluman (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-ang-pintor-at-ang-paraluman-2024'
  )
  return {
    props: {
      movie: selectedMovie
