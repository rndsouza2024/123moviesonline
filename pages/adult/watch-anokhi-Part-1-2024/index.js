...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Anokhi Part 1 Parte (2024) para adultos | 123Movies™',
      'Regarder Anokhi Part 1 Partie (2024) pour adultes | 123Movies™',
      'Anokhi Part 1 Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Anokhi Part 1 (2024) 成人内容 | 123Movies™',
      'Anokhi Part 1 パート (2024) 大人向け | 123Movies™',
      'Anokhi Part 1 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Anokhi Part 1 Parte (2024) para adultos | 123Movies™',
      'Guarda Anokhi Part 1 Parte (2024) per adulti | 123Movies™',
      'Посмотреть Anokhi Part 1 Часть (2024) для взрослых | 123Movies™',
...
export async function getServerSideProps () {
  ...
  const selectedAdult = data.find(adult => adult.id === 'INDEX26')
  return {
    props: {
      adult: selectedAdult
    }
