...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Anokhi Part 1 (2024) | 123Movies™',
    alternateName: [
      'Ver película Anokhi Part 1 (2024) | 123Movies™',
      'Regarder le film Anokhi Part 1 (2024) | 123Movies™',
      'Film Anokhi Part 1 (2024) ansehen | 123Movies™',
      '观看电影 Anokhi Part 1 (2024) | 123Movies™',
      '映画 Anokhi Part 1 (2024) を見る | 123Movies™',
      '영화 Anokhi Part 1 (2024) 보기 | 123Movies™',
      'Assistir Filme Anokhi Part 1 (2024) | 123Movies™',
      'Guarda il film Anokhi Part 1 (2024) | 123Movies™',
      'Посмотреть фильм Anokhi Part 1 (2024) | 123Movies™',
      'مشاهدة فيلم Anokhi Part 1 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Anokhi Part 1 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-anokhi-Part-1-2024'
  )
  return {
    props: {
      movie: selectedMovie
