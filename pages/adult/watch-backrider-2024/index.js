...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Backrider (2024) | 123Movies™',
    alternateName: [
      'Ver película Backrider (2024) | 123Movies™',
      'Regarder le film Backrider (2024) | 123Movies™',
      'Film Backrider (2024) ansehen | 123Movies™',
      '观看电影 Backrider (2024) | 123Movies™',
      '映画 Backrider (2024) を見る | 123Movies™',
      '영화 Backrider (2024) 보기 | 123Movies™',
      'Assistir Filme Backrider (2024) | 123Movies™',
      'Guarda il film Backrider (2024) | 123Movies™',
      'Посмотреть фильм Backrider (2024) | 123Movies™',
      'مشاهدة فيلم Backrider (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Backrider (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-backrider-2024'
  )
  return {
    props: {
      movie: selectedMovie
