...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Call Me Part 02 Parte (2024) para adultos | JWF™',
      'Regarder Call Me Part 02 Partie (2024) pour adultes | JWF™',
      'Call Me Part 02 Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Call Me Part 02 (2024) 成人内容 | JWF™',
      'Call Me Part 02 パート (2024) 大人向け | JWF™',
      'Call Me Part 02 파트 (2024) 성인 전용 | JWF™',
      'Assistir Call Me Part 02 Parte (2024) para adultos | JWF™',
      'Guarda Call Me Part 02 Parte (2024) per adulti | JWF™',
      'Посмотреть Call Me Part 02 Часть (2024) для взрослых | JWF™',
      'مشاهدة Call Me Part 02 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
