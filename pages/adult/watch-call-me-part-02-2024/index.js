...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Call Me Part 2 (2024) | 123Movies™',
    alternateName: [
      'Ver película Call Me Part 2 (2024) | 123Movies™',
      'Regarder le film Call Me Part 2 (2024) | 123Movies™',
      'Film Call Me Part 2 (2024) ansehen | 123Movies™',
      '观看电影 Call Me Part 2 (2024) | 123Movies™',
      '映画 Call Me Part 2 (2024) を見る | 123Movies™',
      '영화 Call Me Part 2 (2024) 보기 | 123Movies™',
      'Assistir Filme Call Me Part 2 (2024) | 123Movies™',
      'Guarda il film Call Me Part 2 (2024) | 123Movies™',
      'Посмотреть фильм Call Me Part 2 (2024) | 123Movies™',
      'مشاهدة فيلم Call Me Part 2 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Call Me Part 2 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-call-me-part-02-2024'
  )
  return {
    props: {
      movie: selectedMovie
