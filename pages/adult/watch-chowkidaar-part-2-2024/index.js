...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Table For 3 (2024) | 123Movies™',
    alternateName: [
      'Ver película Table For 3 (2024) | 123Movies™',
      'Regarder le film Table For 3 (2024) | 123Movies™',
      'Film Table For 3 (2024) ansehen | 123Movies™',
      '观看电影 Table For 3 (2024) | 123Movies™',
      '映画 Table For 3 (2024) を見る | 123Movies™',
      '영화 Table For 3 (2024) 보기 | 123Movies™',
      'Assistir Filme Table For 3 (2024) | 123Movies™',
      'Guarda il film Table For 3 (2024) | 123Movies™',
      'Посмотреть фильм Table For 3 (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Table For 3 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-chowkidaar-part-2-2024'
  )
  return {
    props: {
      movie: selectedMovie
