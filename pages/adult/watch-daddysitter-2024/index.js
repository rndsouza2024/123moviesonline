...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Daddysitter (2024) | 123Movies™',
    alternateName: [
      'Ver Daddysitter Parte (2024) para adultos | 123Movies™',
      'Regarder Daddysitter Partie (2024) pour adultes | 123Movies™',
      'Daddysitter Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Daddysitter (2024) 成人内容 | 123Movies™',
      'Daddysitter パート (2024) 大人向け | 123Movies™',
      'Daddysitter 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Daddysitter Parte (2024) para adultos | 123Movies™',
      'Guarda Daddysitter Parte (2024) per adulti | 123Movies™',
      'Посмотреть Daddysitter Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Daddysitter (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Daddysitter (2024) | 123Movies™</title>
