...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Daddysitter (2024) | 123Movies™',
    alternateName: [
      'Ver película Daddysitter (2024) | 123Movies™',
      'Regarder le film Daddysitter (2024) | 123Movies™',
      'Film Daddysitter (2024) ansehen | 123Movies™',
      '观看电影 Daddysitter (2024) | 123Movies™',
      '映画 Daddysitter (2024) を見る | 123Movies™',
      '영화 Daddysitter (2024) 보기 | 123Movies™',
      'Assistir Filme Daddysitter (2024) | 123Movies™',
      'Guarda il film Daddysitter (2024) | 123Movies™',
      'Посмотреть фильм Daddysitter (2024) | 123Movies™',
      'مشاهدة فيلم Daddysitter (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Daddysitter (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-daddysitter-2024'
  )
  return {
    props: {
      movie: selectedMovie
