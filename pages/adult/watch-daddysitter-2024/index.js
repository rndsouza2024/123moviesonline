...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Daddysitter (2024) para adultos | 123Movies™',
      'Regarder Daddysitter (2024) pour adultes | 123Movies™',
      'Daddysitter (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Daddysitter (2024) 成人内容 | 123Movies™',
      'Daddysitter (2024) 大人向け | 123Movies™',
      'Daddysitter (2024) 성인 전용 | 123Movies™',
      'Assistir Daddysitter (2024) para adultos | 123Movies™',
      'Guarda Daddysitter (2024) per adulti | 123Movies™',
      'Посмотреть Daddysitter (2024) для взрослых | 123Movies™',
