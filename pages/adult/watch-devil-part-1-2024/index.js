...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Devil Part 1 (2024) | JWF™',
    alternateName: [
      'Ver Devil Part 1 Parte (2024) para adultos | JWF™',
      'Regarder Devil Part 1 Partie (2024) pour adultes | JWF™',
      'Devil Part 1 Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Devil Part 1 (2024) 成人内容 | JWF™',
      'Devil Part 1 パート (2024) 大人向け | JWF™',
      'Devil Part 1 파트 (2024) 성인 전용 | JWF™',
      'Assistir Devil Part 1 Parte (2024) para adultos | JWF™',
      'Guarda Devil Part 1 Parte (2024) per adulti | JWF™',
      'Посмотреть Devil Part 1 Часть (2024) для взрослых | JWF™',
      'مشاهدة Devil Part 1 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
