...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Dost Ka Dhokha (2024) | 123Movies™',
    alternateName: [
      'Ver película Dost Ka Dhokha (2024) | 123Movies™',
      'Regarder le film Dost Ka Dhokha (2024) | 123Movies™',
      'Film Dost Ka Dhokha (2024) ansehen | 123Movies™',
      '观看电影 Dost Ka Dhokha (2024) | 123Movies™',
      '映画 Dost Ka Dhokha (2024) を見る | 123Movies™',
      '영화 Dost Ka Dhokha (2024) 보기 | 123Movies™',
      'Assistir Filme Dost Ka Dhokha (2024) | 123Movies™',
      'Guarda il film Dost Ka Dhokha (2024) | 123Movies™',
      'Посмотреть фильм Dost Ka Dhokha (2024) | 123Movies™',
      'مشاهدة فيلم Dost Ka Dhokha (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Dost Ka Dhokha (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-dost-ka-dhokha-2024'
  )
  return {
    props: {
      movie: selectedMovie
