...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Dost Ka Dhokha (2024) | 123Movies™',
    alternateName: [
      'Ver Dost Ka Dhokha Parte (2024) para adultos | 123Movies™',
      'Regarder Dost Ka Dhokha Partie (2024) pour adultes | 123Movies™',
      'Dost Ka Dhokha Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Dost Ka Dhokha (2024) 成人内容 | 123Movies™',
      'Dost Ka Dhokha パート (2024) 大人向け | 123Movies™',
      'Dost Ka Dhokha 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Dost Ka Dhokha Parte (2024) para adultos | 123Movies™',
      'Guarda Dost Ka Dhokha Parte (2024) per adulti | 123Movies™',
      'Посмотреть Dost Ka Dhokha Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Dost Ka Dhokha (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Dost Ka Dhokha (2024) | 123Movies™</title>
