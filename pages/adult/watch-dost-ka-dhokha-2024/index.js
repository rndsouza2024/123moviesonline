...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Dost Ka Dhokha (2024) para adultos | 123Movies™',
      'Regarder Dost Ka Dhokha (2024) pour adultes | 123Movies™',
      'Dost Ka Dhokha (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Dost Ka Dhokha (2024) 成人内容 | 123Movies™',
      'Dost Ka Dhokha (2024) 大人向け | 123Movies™',
      'Dost Ka Dhokha (2024) 성인 전용 | 123Movies™',
      'Assistir Dost Ka Dhokha (2024) para adultos | 123Movies™',
      'Guarda Dost Ka Dhokha (2024) per adulti | 123Movies™',
      'Посмотреть Dost Ka Dhokha (2024) для взрослых | 123Movies™',
