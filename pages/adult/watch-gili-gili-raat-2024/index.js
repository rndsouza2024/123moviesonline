...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Gili Gili Raat (2024) para adultos | 123Movies™',
      'Regarder Gili Gili Raat (2024) pour adultes | 123Movies™',
      'Gili Gili Raat (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Gili Gili Raat (2024) 成人内容 | 123Movies™',
      'Gili Gili Raat (2024) 大人向け | 123Movies™',
      'Gili Gili Raat (2024) 성인 전용 | 123Movies™',
      'Assistir Gili Gili Raat (2024) para adultos | 123Movies™',
      'Guarda Gili Gili Raat (2024) per adulti | 123Movies™',
      'Посмотреть Gili Gili Raat (2024) для взрослых | 123Movies™',
