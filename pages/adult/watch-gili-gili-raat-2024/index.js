...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Gili Gili Raat (2024) | 123Movies™',
    alternateName: [
      'Ver película Gili Gili Raat (2024) | 123Movies™',
      'Regarder le film Gili Gili Raat (2024) | 123Movies™',
      'Film Gili Gili Raat (2024) ansehen | 123Movies™',
      '观看电影 Gili Gili Raat (2024) | 123Movies™',
      '映画 Gili Gili Raat (2024) を見る | 123Movies™',
      '영화 Gili Gili Raat (2024) 보기 | 123Movies™',
      'Assistir Filme Gili Gili Raat (2024) | 123Movies™',
      'Guarda il film Gili Gili Raat (2024) | 123Movies™',
      'Посмотреть фильм Gili Gili Raat (2024) | 123Movies™',
      'مشاهدة فيلم Gili Gili Raat (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Gili Gili Raat (2024) | 123Movies™</title>
