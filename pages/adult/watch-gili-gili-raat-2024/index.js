...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Gili Gili Raat (2024) | 123Movies™',
    alternateName: [
      'Ver Gili Gili Raat Parte (2024) para adultos | 123Movies™',
      'Regarder Gili Gili Raat Partie (2024) pour adultes | 123Movies™',
      'Gili Gili Raat Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Gili Gili Raat (2024) 成人内容 | 123Movies™',
      'Gili Gili Raat パート (2024) 大人向け | 123Movies™',
      'Gili Gili Raat 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Gili Gili Raat Parte (2024) para adultos | 123Movies™',
      'Guarda Gili Gili Raat Parte (2024) per adulti | 123Movies™',
      'Посмотреть Gili Gili Raat Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Gili Gili Raat (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Gili Gili Raat (2024) | 123Movies™</title>
