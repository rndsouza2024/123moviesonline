...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Gustakhiyan (2024) | 123Movies™',
    alternateName: [
      'Ver película Gustakhiyan (2024) | 123Movies™',
      'Regarder le film Gustakhiyan (2024) | 123Movies™',
      'Film Gustakhiyan (2024) ansehen | 123Movies™',
      '观看电影 Gustakhiyan (2024) | 123Movies™',
      '映画 Gustakhiyan (2024) を見る | 123Movies™',
      '영화 Gustakhiyan (2024) 보기 | 123Movies™',
      'Assistir Filme Gustakhiyan (2024) | 123Movies™',
      'Guarda il film Gustakhiyan (2024) | 123Movies™',
      'Посмотреть фильм Gustakhiyan (2024) | 123Movies™',
      'مشاهدة فيلم Gustakhiyan (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Gustakhiyan (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-gustakhiyan-2024'
  )
  return {
    props: {
      movie: selectedMovie
