...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Huwad (2024) | 123Movies™',
    alternateName: [
      'Ver Huwad Parte (2024) para adultos | 123Movies™',
      'Regarder Huwad Partie (2024) pour adultes | 123Movies™',
      'Huwad Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Huwad (2024) 成人内容 | 123Movies™',
      'Huwad パート (2024) 大人向け | 123Movies™',
      'Huwad 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Huwad Parte (2024) para adultos | 123Movies™',
      'Guarda Huwad Parte (2024) per adulti | 123Movies™',
      'Посмотреть Huwad Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Huwad (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Huwad (2024) | 123Movies™</title>
