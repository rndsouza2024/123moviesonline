...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Huwad (2024) | 123Movies™',
    alternateName: [
      'Ver película Huwad (2024) | 123Movies™',
      'Regarder le film Huwad (2024) | 123Movies™',
      'Film Huwad (2024) ansehen | 123Movies™',
      '观看电影 Huwad (2024) | 123Movies™',
      '映画 Huwad (2024) を見る | 123Movies™',
      '영화 Huwad (2024) 보기 | 123Movies™',
      'Assistir Filme Huwad (2024) | 123Movies™',
      'Guarda il film Huwad (2024) | 123Movies™',
      'Посмотреть фильм Huwad (2024) | 123Movies™',
      'مشاهدة فيلم Huwad (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Huwad (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-huwad-2024'
  )
  return {
    props: {
      movie: selectedMovie
