...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Huwad (2024) para adultos | 123Movies™',
      'Regarder Huwad (2024) pour adultes | 123Movies™',
      'Huwad (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Huwad (2024) 成人内容 | 123Movies™',
      'Huwad (2024) 大人向け | 123Movies™',
      'Huwad (2024) 성인 전용 | 123Movies™',
      'Assistir Huwad (2024) para adultos | 123Movies™',
      'Guarda Huwad (2024) per adulti | 123Movies™',
      'Посмотреть Huwad (2024) для взрослых | 123Movies™',
