...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Init (2024) para adultos | 123Movies™',
      'Regarder Init (2024) pour adultes | 123Movies™',
      'Init (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Init (2024) 成人内容 | 123Movies™',
      'Init (2024) 大人向け | 123Movies™',
      'Init (2024) 성인 전용 | 123Movies™',
      'Assistir Init (2024) para adultos | 123Movies™',
      'Guarda Init (2024) per adulti | 123Movies™',
      'Посмотреть Init (2024) для взрослых | 123Movies™',
