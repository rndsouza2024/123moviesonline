...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Init (2024) | 123Movies™',
    alternateName: [
      'Ver Init Parte (2024) para adultos | 123Movies™',
      'Regarder Init Partie (2024) pour adultes | 123Movies™',
      'Init Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Init (2024) 成人内容 | 123Movies™',
      'Init パート (2024) 大人向け | 123Movies™',
      'Init 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Init Parte (2024) para adultos | 123Movies™',
      'Guarda Init Parte (2024) per adulti | 123Movies™',
      'Посмотреть Init Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Init (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Init (2024) | 123Movies™</title>
