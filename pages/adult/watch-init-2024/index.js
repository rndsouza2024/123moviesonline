...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Init (2024) | 123Movies™',
    alternateName: [
      'Ver película Init (2024) | 123Movies™',
      'Regarder le film Init (2024) | 123Movies™',
      'Film Init (2024) ansehen | 123Movies™',
      '观看电影 Init (2024) | 123Movies™',
      '映画 Init (2024) を見る | 123Movies™',
      '영화 Init (2024) 보기 | 123Movies™',
      'Assistir Filme Init (2024) | 123Movies™',
      'Guarda il film Init (2024) | 123Movies™',
      'Посмотреть фильм Init (2024) | 123Movies™',
      'مشاهدة فيلم Init (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Init (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-init-2024'
  )
  return {
    props: {
      movie: selectedMovie
