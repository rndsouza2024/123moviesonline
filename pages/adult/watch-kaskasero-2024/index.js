...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Kaskasero (2024) para adultos | 123Movies™',
      'Regarder Kaskasero (2024) pour adultes | 123Movies™',
      'Kaskasero (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Kaskasero (2024) 成人内容 | 123Movies™',
      'Kaskasero (2024) 大人向け | 123Movies™',
      'Kaskasero (2024) 성인 전용 | 123Movies™',
      'Assistir Kaskasero (2024) para adultos | 123Movies™',
      'Guarda Kaskasero (2024) per adulti | 123Movies™',
      'Посмотреть Kaskasero (2024) для взрослых | 123Movies™',
