...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kaskasero (2024) | 123Movies™',
    alternateName: [
      'Ver película Kaskasero (2024) | 123Movies™',
      'Regarder le film Kaskasero (2024) | 123Movies™',
      'Film Kaskasero (2024) ansehen | 123Movies™',
      '观看电影 Kaskasero (2024) | 123Movies™',
      '映画 Kaskasero (2024) を見る | 123Movies™',
      '영화 Kaskasero (2024) 보기 | 123Movies™',
      'Assistir Filme Kaskasero (2024) | 123Movies™',
      'Guarda il film Kaskasero (2024) | 123Movies™',
      'Посмотреть фильм Kaskasero (2024) | 123Movies™',
      'مشاهدة فيلم Kaskasero (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kaskasero (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-kaskasero-2024'
  )
  return {
    props: {
      movie: selectedMovie
