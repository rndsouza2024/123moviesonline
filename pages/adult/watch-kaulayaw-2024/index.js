...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Kaulayaw (2024) | 123Movies™',
    alternateName: [
      'Ver Kaulayaw Parte (2024) para adultos | 123Movies™',
      'Regarder Kaulayaw Partie (2024) pour adultes | 123Movies™',
      'Kaulayaw Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Kaulayaw (2024) 成人内容 | 123Movies™',
      'Kaulayaw パート (2024) 大人向け | 123Movies™',
      'Kaulayaw 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Kaulayaw Parte (2024) para adultos | 123Movies™',
      'Guarda Kaulayaw Parte (2024) per adulti | 123Movies™',
      'Посмотреть Kaulayaw Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Kaulayaw (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Kaulayaw (2024) | 123Movies™</title>
