...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Kaulayaw (2024) para adultos | 123Movies™',
      'Regarder Kaulayaw (2024) pour adultes | 123Movies™',
      'Kaulayaw (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Kaulayaw (2024) 成人内容 | 123Movies™',
      'Kaulayaw (2024) 大人向け | 123Movies™',
      'Kaulayaw (2024) 성인 전용 | 123Movies™',
      'Assistir Kaulayaw (2024) para adultos | 123Movies™',
      'Guarda Kaulayaw (2024) per adulti | 123Movies™',
      'Посмотреть Kaulayaw (2024) для взрослых | 123Movies™',
