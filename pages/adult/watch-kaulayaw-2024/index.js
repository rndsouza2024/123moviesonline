...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kaulayaw (2024) | 123Movies™',
    alternateName: [
      'Ver película Kaulayaw (2024) | 123Movies™',
      'Regarder le film Kaulayaw (2024) | 123Movies™',
      'Film Kaulayaw (2024) ansehen | 123Movies™',
      '观看电影 Kaulayaw (2024) | 123Movies™',
      '映画 Kaulayaw (2024) を見る | 123Movies™',
      '영화 Kaulayaw (2024) 보기 | 123Movies™',
      'Assistir Filme Kaulayaw (2024) | 123Movies™',
      'Guarda il film Kaulayaw (2024) | 123Movies™',
      'Посмотреть фильм Kaulayaw (2024) | 123Movies™',
      'مشاهدة فيلم Kaulayaw (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kaulayaw (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-kaulayaw-2024'
  )
  return {
    props: {
      movie: selectedMovie
