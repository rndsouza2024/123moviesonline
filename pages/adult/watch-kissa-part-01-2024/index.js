...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kissa Part 01 (2024) | 123Movies™',
    alternateName: [
      'Ver película Kissa Part 01 (2024) | 123Movies™',
      'Regarder le film Kissa Part 01 (2024) | 123Movies™',
      'Film Kissa Part 01 (2024) ansehen | 123Movies™',
      '观看电影 Kissa Part 01 (2024) | 123Movies™',
      '映画 Kissa Part 01 (2024) を見る | 123Movies™',
      '영화 Kissa Part 01 (2024) 보기 | 123Movies™',
      'Assistir Filme Kissa Part 01 (2024) | 123Movies™',
      'Guarda il film Kissa Part 01 (2024) | 123Movies™',
      'Посмотреть фильм Kissa Part 01 (2024) | 123Movies™',
      'مشاهدة فيلم Kissa Part 01 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kissa Part 01 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-kissa-part-01-2024'
  )
  return {
    props: {
      movie: selectedMovie
