...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Kissa Part 02 Parte (2024) para adultos | JWF™',
      'Regarder Kissa Part 02 Partie (2024) pour adultes | JWF™',
      'Kissa Part 02 Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Kissa Part 02 (2024) 成人内容 | JWF™',
      'Kissa Part 02 パート (2024) 大人向け | JWF™',
      'Kissa Part 02 파트 (2024) 성인 전용 | JWF™',
      'Assistir Kissa Part 02 Parte (2024) para adultos | JWF™',
      'Guarda Kissa Part 02 Parte (2024) per adulti | JWF™',
      'Посмотреть Kissa Part 02 Часть (2024) для взрослых | JWF™',
      'مشاهدة Kissa Part 02 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
