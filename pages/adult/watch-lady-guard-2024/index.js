...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Lady Guard (2024) para adultos | 123Movies™',
      'Regarder Lady Guard (2024) pour adultes | 123Movies™',
      'Lady Guard (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Lady Guard (2024) 成人内容 | 123Movies™',
      'Lady Guard (2024) 大人向け | 123Movies™',
      'Lady Guard (2024) 성인 전용 | 123Movies™',
      'Assistir Lady Guard (2024) para adultos | 123Movies™',
      'Guarda Lady Guard (2024) per adulti | 123Movies™',
      'Посмотреть Lady Guard (2024) для взрослых | 123Movies™',
