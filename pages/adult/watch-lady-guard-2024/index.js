...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Lady Guard (2024) | 123Movies™',
    alternateName: [
      'Ver película Lady Guard (2024) | 123Movies™',
      'Regarder le film Lady Guard (2024) | 123Movies™',
      'Film Lady Guard (2024) ansehen | 123Movies™',
      '观看电影 Lady Guard (2024) | 123Movies™',
      '映画 Lady Guard (2024) を見る | 123Movies™',
      '영화 Lady Guard (2024) 보기 | 123Movies™',
      'Assistir Filme Lady Guard (2024) | 123Movies™',
      'Guarda il film Lady Guard (2024) | 123Movies™',
      'Посмотреть фильм Lady Guard (2024) | 123Movies™',
      'مشاهدة فيلم Lady Guard (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Lady Guard (2024) | 123Movies™</title>
