...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Lady Guard (2024) | 123Movies™',
    alternateName: [
      'Ver Lady Guard Parte (2024) para adultos | 123Movies™',
      'Regarder Lady Guard Partie (2024) pour adultes | 123Movies™',
      'Lady Guard Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Lady Guard (2024) 成人内容 | 123Movies™',
      'Lady Guard パート (2024) 大人向け | 123Movies™',
      'Lady Guard 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Lady Guard Parte (2024) para adultos | 123Movies™',
      'Guarda Lady Guard Parte (2024) per adulti | 123Movies™',
      'Посмотреть Lady Guard Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Lady Guard (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Lady Guard (2024) | 123Movies™</title>
