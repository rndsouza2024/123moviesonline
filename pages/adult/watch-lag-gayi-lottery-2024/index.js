...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Lag Gayi Lottery (2024) | 123Movies™',
    alternateName: [
      'Ver Lag Gayi Lottery Parte (2024) para adultos | 123Movies™',
      'Regarder Lag Gayi Lottery Partie (2024) pour adultes | 123Movies™',
      'Lag Gayi Lottery Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Lag Gayi Lottery (2024) 成人内容 | 123Movies™',
      'Lag Gayi Lottery パート (2024) 大人向け | 123Movies™',
      'Lag Gayi Lottery 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Lag Gayi Lottery Parte (2024) para adultos | 123Movies™',
      'Guarda Lag Gayi Lottery Parte (2024) per adulti | 123Movies™',
      'Посмотреть Lag Gayi Lottery Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Lag Gayi Lottery (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Lag Gayi Lottery (2024) | 123Movies™</title>
