...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Lag Gayi Lottery (2024) | 123Movies™',
    alternateName: [
      'Ver película Lag Gayi Lottery (2024) | 123Movies™',
      'Regarder le film Lag Gayi Lottery (2024) | 123Movies™',
      'Film Lag Gayi Lottery (2024) ansehen | 123Movies™',
      '观看电影 Lag Gayi Lottery (2024) | 123Movies™',
      '映画 Lag Gayi Lottery (2024) を見る | 123Movies™',
      '영화 Lag Gayi Lottery (2024) 보기 | 123Movies™',
      'Assistir Filme Lag Gayi Lottery (2024) | 123Movies™',
      'Guarda il film Lag Gayi Lottery (2024) | 123Movies™',
      'Посмотреть фильм Lag Gayi Lottery (2024) | 123Movies™',
      'مشاهدة فيلم Lag Gayi Lottery (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Lag Gayi Lottery (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-lag-gayi-lottery-2024'
  )
  return {
    props: {
      movie: selectedMovie
