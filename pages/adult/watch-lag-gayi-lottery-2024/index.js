...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Lag Gayi Lottery (2024) para adultos | 123Movies™',
      'Regarder Lag Gayi Lottery (2024) pour adultes | 123Movies™',
      'Lag Gayi Lottery (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Lag Gayi Lottery (2024) 成人内容 | 123Movies™',
      'Lag Gayi Lottery (2024) 大人向け | 123Movies™',
      'Lag Gayi Lottery (2024) 성인 전용 | 123Movies™',
      'Assistir Lag Gayi Lottery (2024) para adultos | 123Movies™',
      'Guarda Lag Gayi Lottery (2024) per adulti | 123Movies™',
      'Посмотреть Lag Gayi Lottery (2024) для взрослых | 123Movies™',
