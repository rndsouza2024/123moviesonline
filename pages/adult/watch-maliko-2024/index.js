...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Maliko (2024) | 123Movies™',
    alternateName: [
      'Ver película Maliko (2024) | 123Movies™',
      'Regarder le film Maliko (2024) | 123Movies™',
      'Film Maliko (2024) ansehen | 123Movies™',
      '观看电影 Maliko (2024) | 123Movies™',
      '映画 Maliko (2024) を見る | 123Movies™',
      '영화 Maliko (2024) 보기 | 123Movies™',
      'Assistir Filme Maliko (2024) | 123Movies™',
      'Guarda il film Maliko (2024) | 123Movies™',
      'Посмотреть фильм Maliko (2024) | 123Movies™',
      'مشاهدة فيلم Maliko (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Maliko (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-maliko-2024'
  )
  return {
    props: {
      movie: selectedMovie
