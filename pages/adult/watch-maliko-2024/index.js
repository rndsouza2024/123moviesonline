...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Maliko (2024) | 123Movies™',
    alternateName: [
      'Ver Maliko Parte (2024) para adultos | 123Movies™',
      'Regarder Maliko Partie (2024) pour adultes | 123Movies™',
      'Maliko Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Maliko (2024) 成人内容 | 123Movies™',
      'Maliko パート (2024) 大人向け | 123Movies™',
      'Maliko 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Maliko Parte (2024) para adultos | 123Movies™',
      'Guarda Maliko Parte (2024) per adulti | 123Movies™',
      'Посмотреть Maliko Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Maliko (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Maliko (2024) | 123Movies™</title>
