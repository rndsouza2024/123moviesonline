...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Mastani Shabbo (2024) | 123Movies™',
    alternateName: [
      'Ver película Mastani Shabbo (2024) | 123Movies™',
      'Regarder le film Mastani Shabbo (2024) | 123Movies™',
      'Film Mastani Shabbo (2024) ansehen | 123Movies™',
      '观看电影 Mastani Shabbo (2024) | 123Movies™',
      '映画 Mastani Shabbo (2024) を見る | 123Movies™',
      '영화 Mastani Shabbo (2024) 보기 | 123Movies™',
      'Assistir Filme Mastani Shabbo (2024) | 123Movies™',
      'Guarda il film Mastani Shabbo (2024) | 123Movies™',
      'Посмотреть фильм Mastani Shabbo (2024) | 123Movies™',
      'مشاهدة فيلم Mastani Shabbo (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Mastani Shabbo (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-mastani-shabbo-2024'
  )
  return {
    props: {
      movie: selectedMovie
