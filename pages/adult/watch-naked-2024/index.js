...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Naked (2024) | 123Movies™',
    alternateName: [
      'Ver película Naked (2024) | 123Movies™',
      'Regarder le film Naked (2024) | 123Movies™',
      'Film Naked (2024) ansehen | 123Movies™',
      '观看电影 Naked (2024) | 123Movies™',
      '映画 Naked (2024) を見る | 123Movies™',
      '영화 Naked (2024) 보기 | 123Movies™',
      'Assistir Filme Naked (2024) | 123Movies™',
      'Guarda il film Naked (2024) | 123Movies™',
      'Посмотреть фильм Naked (2024) | 123Movies™',
      'مشاهدة فيلم Naked (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Naked (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-naked-2024'
  )
  return {
    props: {
      movie: selectedMovie
