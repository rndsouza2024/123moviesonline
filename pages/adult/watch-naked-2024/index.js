...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Naked (2024) | 123Movies™',
    alternateName: [
      'Ver Naked Parte (2024) para adultos | 123Movies™',
      'Regarder Naked Partie (2024) pour adultes | 123Movies™',
      'Naked Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Naked (2024) 成人内容 | 123Movies™',
      'Naked パート (2024) 大人向け | 123Movies™',
      'Naked 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Naked Parte (2024) para adultos | 123Movies™',
      'Guarda Naked Parte (2024) per adulti | 123Movies™',
      'Посмотреть Naked Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Naked (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Naked (2024) | 123Movies™</title>
