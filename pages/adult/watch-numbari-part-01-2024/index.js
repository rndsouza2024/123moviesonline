...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Numbari Part 01 (2024) | 123Movies™',
    alternateName: [
      'Ver película Numbari Part 01 (2024) | 123Movies™',
      'Regarder le film Numbari Part 01 (2024) | 123Movies™',
      'Film Numbari Part 01 (2024) ansehen | 123Movies™',
      '观看电影 Numbari Part 01 (2024) | 123Movies™',
      '映画 Numbari Part 01 (2024) を見る | 123Movies™',
      '영화 Numbari Part 01 (2024) 보기 | 123Movies™',
      'Assistir Filme Numbari Part 01 (2024) | 123Movies™',
      'Guarda il film Numbari Part 01 (2024) | 123Movies™',
      'Посмотреть фильм Numbari Part 01 (2024) | 123Movies™',
      'مشاهدة فيلم Numbari Part 01 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Numbari Part 01 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-numbari-part-01-2024'
  )
  return {
    props: {
      movie: selectedMovie
