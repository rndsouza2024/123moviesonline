...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Package Deal (2024) | 123Movies™',
    alternateName: [
      'Ver película Package Deal (2024) | 123Movies™',
      'Regarder le film Package Deal (2024) | 123Movies™',
      'Film Package Deal (2024) ansehen | 123Movies™',
      '观看电影 Package Deal (2024) | 123Movies™',
      '映画 Package Deal (2024) を見る | 123Movies™',
      '영화 Package Deal (2024) 보기 | 123Movies™',
      'Assistir Filme Package Deal (2024) | 123Movies™',
      'Guarda il film Package Deal (2024) | 123Movies™',
      'Посмотреть фильм Package Deal (2024) | 123Movies™',
      'مشاهدة فيلم Package Deal (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Package Deal (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-package-deal-2024'
  )
  return {
    props: {
      movie: selectedMovie
