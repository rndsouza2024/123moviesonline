...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      ...
      'Regarder Package Deal Partie (2024) pour adultes | 123Movies™',
      'Package Deal Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Package Deal (2024) 成人内容 | 123Movies™',
      'Package Deal パート (2024) 大人向け | 123Movies™',
      'Package Deal 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Package Deal Parte (2024) para adultos | 123Movies™',
      'Guarda Package Deal Parte (2024) per adulti | 123Movies™',
      'Посмотреть Package Deal Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Package Deal (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Package Deal (2024) | 123Movies™</title>
