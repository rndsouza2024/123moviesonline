...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Package Deal (2024) para adultos | 123Movies™',
      'Regarder Package Deal (2024) pour adultes | 123Movies™',
      'Package Deal (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Package Deal (2024) 成人内容 | 123Movies™',
      'Package Deal (2024) 大人向け | 123Movies™',
      'Package Deal (2024) 성인 전용 | 123Movies™',
      'Assistir Package Deal (2024) para adultos | 123Movies™',
      'Guarda Package Deal (2024) per adulti | 123Movies™',
      'Посмотреть Package Deal (2024) для взрослых | 123Movies™',
