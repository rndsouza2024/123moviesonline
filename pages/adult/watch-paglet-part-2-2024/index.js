...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Paglet Part 2 (2024) | 123Movies™',
    alternateName: [
      'Ver película Paglet Part 2 (2024) | 123Movies™',
      'Regarder le film Paglet Part 2 (2024) | 123Movies™',
      'Film Paglet Part 2 (2024) ansehen | 123Movies™',
      '观看电影 Paglet Part 2 (2024) | 123Movies™',
      '映画 Paglet Part 2 (2024) を見る | 123Movies™',
      '영화 Paglet Part 2 (2024) 보기 | 123Movies™',
      'Assistir Filme Paglet Part 2 (2024) | 123Movies™',
      'Guarda il film Paglet Part 2 (2024) | 123Movies™',
      'Посмотреть фильм Paglet Part 2 (2024) | 123Movies™',
      'مشاهدة فيلم Paglet Part 2 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Paglet Part 2 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-paglet-part-2-2024'
  )
  return {
    props: {
      movie: selectedMovie
