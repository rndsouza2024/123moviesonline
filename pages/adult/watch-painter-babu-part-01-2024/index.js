...
const adultDetail = ({ adult }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('http://localhost:3000/adultfinal.json')
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'Person',
        '@id': 'http://localhost:3000/author/azmovies/',
        name: 'Dr Trailer',
        url: 'http://localhost:3000/author/azmovies/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        headline: ` ${adult.name} |  123Movies Online™`,
        datePublished: adult.datePublished,
        dateModified: adult.dateModified,
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'http://localhost:3000/adult/watch-pretty-boys-2024',
    name: 'Watch Adult Painter Babu Part 01 (2024) | 123Movies™',
    alternateName: [
      'Ver Painter Babu Part 01 Parte (2024) para adultos | 123Movies™',
      'Regarder Painter Babu Part 01 Partie (2024) pour adultes | 123Movies™',
      'Painter Babu Part 01 Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Painter Babu Part 01 (2024) 成人内容 | 123Movies™',
      'Painter Babu Part 01 パート (2024) 大人向け | 123Movies™',
      'Painter Babu Part 01 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Painter Babu Part 01 Parte (2024) para adultos | 123Movies™',
      'Guarda Painter Babu Part 01 Parte (2024) per adulti | 123Movies™',
      'Посмотреть Painter Babu Part 01 Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Painter Babu Part 01 (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Painter Babu Part 01 (2024) | 123Movies™</title>
        ...
        <meta
          property='og:title'
          content={`${adult && adult.name} -  123Movies Online`}
        />
        <meta
...
export async function getServerSideProps () {
  const res = await fetch('http://localhost:3000/adultp2.json')
