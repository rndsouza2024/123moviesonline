...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Painter Babu Part 01 Parte (2024) para adultos | JWF™',
      'Regarder Painter Babu Part 01 Partie (2024) pour adultes | JWF™',
      'Painter Babu Part 01 Teil (2024) für Erwachsene ansehen | JWF™',
      '观看 Painter Babu Part 01 (2024) 成人内容 | JWF™',
      'Painter Babu Part 01 パート (2024) 大人向け | JWF™',
      'Painter Babu Part 01 파트 (2024) 성인 전용 | JWF™',
      'Assistir Painter Babu Part 01 Parte (2024) para adultos | JWF™',
      'Guarda Painter Babu Part 01 Parte (2024) per adulti | JWF™',
      'Посмотреть Painter Babu Part 01 Часть (2024) для взрослых | JWF™',
      'مشاهدة Painter Babu Part 01 (2024) للكبار فقط | JWF™'
    ],
    inLanguage: [
