...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Painter Babu Part 01 (2024) | 123Movies™',
    alternateName: [
      'Ver película Painter Babu Part 01 (2024) | 123Movies™',
      'Regarder le film Painter Babu Part 01 (2024) | 123Movies™',
      'Film Painter Babu Part 01 (2024) ansehen | 123Movies™',
      '观看电影 Painter Babu Part 01 (2024) | 123Movies™',
      '映画 Painter Babu Part 01 (2024) を見る | 123Movies™',
      '영화 Painter Babu Part 01 (2024) 보기 | 123Movies™',
      'Assistir Filme Painter Babu Part 01 (2024) | 123Movies™',
      'Guarda il film Painter Babu Part 01 (2024) | 123Movies™',
      'Посмотреть фильм Painter Babu Part 01 (2024) | 123Movies™',
      'مشاهدة فيلم Painter Babu Part 01 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Painter Babu Part 01 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-painter-babu-part-01-2024'
  )
  return {
    props: {
      movie: selectedMovie
