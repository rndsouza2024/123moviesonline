...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Pretty Boys (2024) | 123Movies™',
    alternateName: [
      'Ver película Pretty Boys (2024) | 123Movies™',
      'Regarder le film Pretty Boys (2024) | 123Movies™',
      'Film Pretty Boys (2024) ansehen | 123Movies™',
      '观看电影 Pretty Boys (2024) | 123Movies™',
      '映画 Pretty Boys (2024) を見る | 123Movies™',
      '영화 Pretty Boys (2024) 보기 | 123Movies™',
      'Assistir Filme Pretty Boys (2024) | 123Movies™',
      'Guarda il film Pretty Boys (2024) | 123Movies™',
      'Посмотреть фильм Pretty Boys (2024) | 123Movies™',
      'مشاهدة فيلم Pretty Boys (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Pretty Boys (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-pretty-boys-2024'
  )
  return {
    props: {
      movie: selectedMovie
