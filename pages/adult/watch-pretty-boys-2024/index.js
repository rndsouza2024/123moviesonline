...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Adult Pretty Boys (2024) | 123Movies™',
    alternateName: [
      'Ver Pretty Boys Parte (2024) para adultos | 123Movies™',
      'Regarder Pretty Boys Partie (2024) pour adultes | 123Movies™',
      'Pretty Boys Teil (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Pretty Boys (2024) 成人内容 | 123Movies™',
      'Pretty Boys パート (2024) 大人向け | 123Movies™',
      'Pretty Boys 파트 (2024) 성인 전용 | 123Movies™',
      'Assistir Pretty Boys Parte (2024) para adultos | 123Movies™',
      'Guarda Pretty Boys Parte (2024) per adulti | 123Movies™',
      'Посмотреть Pretty Boys Часть (2024) для взрослых | 123Movies™',
      'مشاهدة Pretty Boys (2024) للكبار فقط | 123Movies™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Pretty Boys (2024) | 123Movies™</title>
