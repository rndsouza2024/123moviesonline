...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Private Tutor (2024) | 123Movies™',
    alternateName: [
      'Ver película Private Tutor (2024) | 123Movies™',
      'Regarder le film Private Tutor (2024) | 123Movies™',
      'Film Private Tutor (2024) ansehen | 123Movies™',
      '观看电影 Private Tutor (2024) | 123Movies™',
      '映画 Private Tutor (2024) を見る | 123Movies™',
      '영화 Private Tutor (2024) 보기 | 123Movies™',
      'Assistir Filme Private Tutor (2024) | 123Movies™',
      'Guarda il film Private Tutor (2024) | 123Movies™',
      'Посмотреть фильм Private Tutor (2024) | 123Movies™',
      'مشاهدة فيلم Private Tutor (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Private Tutor (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-private-tutor-2024'
  )
  return {
    props: {
      movie: selectedMovie
