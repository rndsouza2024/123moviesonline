...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Raat Baaki Hai Part 01 (2024) | 123Movies™',
    alternateName: [
      'Ver película Raat Baaki Hai Part 01 (2024) | 123Movies™',
      'Regarder le film Raat Baaki Hai Part 01 (2024) | 123Movies™',
      'Film Raat Baaki Hai Part 01 (2024) ansehen | 123Movies™',
      '观看电影 Raat Baaki Hai Part 01 (2024) | 123Movies™',
      '映画 Raat Baaki Hai Part 01 (2024) を見る | 123Movies™',
      '영화 Raat Baaki Hai Part 01 (2024) 보기 | 123Movies™',
      'Assistir Filme Raat Baaki Hai Part 01 (2024) | 123Movies™',
      'Guarda il film Raat Baaki Hai Part 01 (2024) | 123Movies™',
      'Посмотреть фильм Raat Baaki Hai Part 01 (2024) | 123Movies™',
      'مشاهدة فيلم Raat Baaki Hai Part 01 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Raat Baaki Hai Part 01 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-raat-baaki-hai-part-1-2024'
  )
  return {
    props: {
      movie: selectedMovie
