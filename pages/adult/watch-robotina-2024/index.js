...
const adultDetail = ({ adult }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver Robotina (2024) para adultos | 123Movies™',
      'Regarder Robotina (2024) pour adultes | 123Movies™',
      'Robotina (2024) für Erwachsene ansehen | 123Movies™',
      '观看 Robotina (2024) 成人内容 | 123Movies™',
      'Robotina (2024) 大人向け | 123Movies™',
      'Robotina (2024) 성인 전용 | 123Movies™',
      'Assistir Robotina (2024) para adultos | 123Movies™',
      'Guarda Robotina (2024) per adulti | 123Movies™',
      'Посмотреть Robotina (2024) для взрослых | 123Movies™',
