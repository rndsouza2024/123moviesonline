...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Robotina (2024) | 123Movies™',
    alternateName: [
      'Ver película Robotina (2024) | 123Movies™',
      'Regarder le film Robotina (2024) | 123Movies™',
      'Film Robotina (2024) ansehen | 123Movies™',
      '观看电影 Robotina (2024) | 123Movies™',
      '映画 Robotina (2024) を見る | 123Movies™',
      '영화 Robotina (2024) 보기 | 123Movies™',
      'Assistir Filme Robotina (2024) | 123Movies™',
      'Guarda il film Robotina (2024) | 123Movies™',
      'Посмотреть фильм Robotina (2024) | 123Movies™',
      'مشاهدة فيلم Robotina (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Robotina (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-robotina-2024'
  )
  return {
    props: {
      movie: selectedMovie
