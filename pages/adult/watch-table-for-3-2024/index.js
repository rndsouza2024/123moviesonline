...
const moviesDetail = ({ movie }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: ` ${movie.name} | XXXXXXXXXX™`,
        datePublished: movie.datePublished,
        dateModified: movie.dateModified,
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Table For 3 (2024) | XXXXXXXXXX™',
    alternateName: [
      'Ver película Table For 3 (2024) | XXXXXXXXXX™',
      'Regarder le film Table For 3 (2024) | XXXXXXXXXX™',
      'Film Table For 3 (2024) ansehen | XXXXXXXXXX™',
      '观看电影 Table For 3 (2024) | XXXXXXXXXX™',
      '映画 Table For 3 (2024) を見る | XXXXXXXXXX™',
      '영화 Table For 3 (2024) 보기 | XXXXXXXXXX™',
      'Assistir Filme Table For 3 (2024) | XXXXXXXXXX™',
      'Guarda il film Table For 3 (2024) | XXXXXXXXXX™',
      'Посмотреть фильм Table For 3 (2024) | XXXXXXXXXX™',
      'مشاهدة فيلم Table For 3 (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Table For 3 (2024) | XXXXXXXXXX™</title>
        ...
        <meta
          property='og:title'
          content={`${movie && movie.name} - XXXXXXXXXX™`}
        />
        <meta
          property='og:description'
          content='Stream HD movies and TV series for free on XXXXXXXXXX™. Explore, stream, and download full-length movies and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${movie.title} available on XXXXXXXXXX™. Enjoy free streaming of full-length movies and TV series online with no registration required.`}
        />
        ...
        <meta
          name='twitter:title'
          content='XXXXXXXXXX™ - Explore. Discover. Online. '
        />
        <meta
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong> XXXXXXXXXX™</strong>, you can stream{' '}
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>XXXXXXXXXX™</strong> ensures that you won't miss a single
              moment of the action, drama, or comedy that makes this TV series a
              must-watch. With high-quality streaming and user-friendly
              navigation, <strong>XXXXXXXXXX™</strong> provides everything you
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong> on <strong>XXXXXXXXXX™</strong> is
              ...
              <strong>XXXXXXXXXX™</strong>, your favorite TV series is just a
              click away.
            </p>
          </>
        )}
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong>. At <strong>XXXXXXXXXX™</strong>,
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              Streaming <strong>{movie.title}</strong> on{' '}
              <strong>XXXXXXXXXX™</strong> provides you with a user-friendly
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>XXXXXXXXXX™</strong>. Our platform ensures your privacy
              and security while you enjoy the content you love. Start streaming{' '}
              <strong>{movie.title}</strong> today and discover why{' '}
              <strong>XXXXXXXXXX™</strong> is the trusted choice for adult
              content.
            </p>
          </>
        )}
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              available to stream right here. At <strong>XXXXXXXXXX™</strong>,
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              Streaming <strong>{movie.title}</strong> on{' '}
              <strong>XXXXXXXXXX™</strong> guarantees a seamless viewing
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>XXXXXXXXXX™</strong>, your entertainment is just a click
              away.
            </p>
          </>
        )}
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-table-for-3-2024'
  )
  return {
    props: {
      movie: selectedMovie
