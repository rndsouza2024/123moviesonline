...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Wild Dulhan (2024) | 123Movies™',
    alternateName: [
      'Ver película Wild Dulhan (2024) | 123Movies™',
      'Regarder le film Wild Dulhan (2024) | 123Movies™',
      'Film Wild Dulhan (2024) ansehen | 123Movies™',
      '观看电影 Wild Dulhan (2024) | 123Movies™',
      '映画 Wild Dulhan (2024) を見る | 123Movies™',
      '영화 Wild Dulhan (2024) 보기 | 123Movies™',
      'Assistir Filme Wild Dulhan (2024) | 123Movies™',
      'Guarda il film Wild Dulhan (2024) | 123Movies™',
      'Посмотреть фильм Wild Dulhan (2024) | 123Movies™',
      'مشاهدة فيلم Wild Dulhan (2024) | 123 فيلم™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Wild Dulhan (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-wild-dulhan-2024'
  )
  return {
    props: {
      movie: selectedMovie
