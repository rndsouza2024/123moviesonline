...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movies-online.vercel.app/home/',
  headline: 'Movies Section | 123Movies™',
  url: 'https://123movies-online.vercel.app/home/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movies-online.vercel.app/home/'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section | 123Movies™</title>
        <link rel='canonical' href='https://123movies-online.vercel.app/home/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section | 123Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://123movies-online.vercel.app/home' />
...
//   try {
//     const res = await fetch('https://123movies-online.vercel.app/home.json')
