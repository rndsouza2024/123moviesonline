...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movies-free.vercel.app/home/',
  headline: 'Movies Section | 123Movies™',
  url: 'https://123movies-free.vercel.app/home/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movies-free.vercel.app/home/'
    }
  ]
})
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123movies-free.vercel.app/home/' />
        <meta
          name='robots'
        ...
        <meta property='og:url' content='https://123movies-free.vercel.app/home' />
...
//   try {
//     const res = await fetch('https://123movies-free.vercel.app/home.json')
