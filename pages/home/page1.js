...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'http://localhost:3000/page3p3',
  headline: 'movies Section | 123Moviesonline™',
  url: 'http://localhost:3000/page3p3',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'http://localhost:3000/page3p3'
    }
  ]
})
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'http://localhost:3000/page2'
      }
    ]
  })
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='http://localhost:3000/page3p3' />
        <meta
          name='robots'
        ...
        <meta property='og:url' content='http://localhost:3000/page3' />
