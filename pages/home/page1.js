...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movies-online.vercel.app/page1',
  headline: 'Main Section 1 | 123Movies™',
  url: 'https://123movies-online.vercel.app/page1',
  description:
  ...
  image: 'https://123movies-online.vercel.app/og_image.jpg',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movies-online.vercel.app/page1'
    }
  ]
})
...
const page1 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    ...
    '@type': 'Article',
    '@id': 'https://123movies-online.vercel.app/page1',
    headline: 'Movies Section | 123Movies™',
    url: 'https://123movies-online.vercel.app/page1',
    description:
      '123Movies - Stream HD movies and TV series for free on 123Movies Online. Explore, stream, and download full-length movies and shows in HD quality without registration.',
    image: 'https://123movies-online.vercel.app/og_image.jpg',
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 1 | 123Movies™</title>
        <link rel='canonical' href='https://123movies-online.vercel.app/page1' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 1 | 123Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://123movies-online.vercel.app/page1' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movies-online.vercel.app/movies.json')
