...
const page9 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 10 | Popcornflix™</title>
        ...
        <meta property='og:title' content=' Page 10 | Popcornflix™' />
        <meta
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://popcornfliks.vercel.app/moviesp6.json');
