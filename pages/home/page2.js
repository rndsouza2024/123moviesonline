...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movies-online.vercel.app/page2',
  headline: 'Main Section 2 | 123Movies™',
  url: 'https://123movies-online.vercel.app/page2',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movies-online.vercel.app/page2'
    }
  ]
})
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123movies-online.vercel.app/page2' />
        <meta
          name='robots'
        ...
        <meta property='og:url' content='https://123movies-online.vercel.app/page2' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movies-online.vercel.app/moviesp8.json')
