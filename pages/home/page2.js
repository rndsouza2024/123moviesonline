...
const page2 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://123moviesonline.vercel.app/page2',
    headline: 'Page 2 | 123 Movies™',
    url: 'https://123moviesonline.vercel.app/page2',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://123moviesonline.vercel.app/page2'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Page 2 | 123 Movies™</title>
        <link rel='canonical' href='https://123moviesonline.vercel.app/page2' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Page 2 | 123 Movies™' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://123moviesonline.vercel.app/page2'
        />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123moviesonline.vercel.app/moviesp11.json')
