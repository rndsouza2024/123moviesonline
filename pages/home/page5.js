...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movies-online.vercel.app/page5',
  headline: 'Main Section 5 | 123Movies™',
  url: 'https://123movies-online.vercel.app/page5',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movies-online.vercel.app/page5'
    }
  ]
})
...
const page5 = ({ items }) => {
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        <title> Main Section 5 | 123Movies™</title>
        <link rel='canonical' href='https://123movies-online.vercel.app/page5' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Main Section 5 | 123Movies™' />
        <meta
        ...
        <meta property='og:url' content='https://123movies-online.vercel.app/page5' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movies-online.vercel.app/moviesp4.json')
