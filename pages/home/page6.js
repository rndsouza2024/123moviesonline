...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123movies-online.vercel.app/page6',
  headline: 'Main Section 6 | 123Movies™',
  url: 'https://123movies-online.vercel.app/page6',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123movies-online.vercel.app/page6'
    }
  ]
})
  ...
  return (
    ...
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123movies-online.vercel.app/page6' />
        <meta
          name='robots'
        ...
        <meta property='og:url' content='https://123movies-online.vercel.app/page6' />
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123movies-online.vercel.app/moviesp5.json')
