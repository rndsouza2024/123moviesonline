...
const page6 = ({ items }) => {
  ...
  const softwareSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'Article',
    '@id': 'https://123moviesonline.vercel.app/page6',
    headline: 'Page 6 | 123 Movies™',
    url: 'https://123moviesonline.vercel.app/page6',
    description:
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'movies',
        item: 'https://123moviesonline.vercel.app/page6'
      }
    ]
  })
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#000' }}>
      <Head>
        ...
        <meta property='og:title' content=' Page 6 | 123 Movies™' />
        <meta
        ...
        <meta
          property='og:url'
          content='https://123moviesonline.vercel.app/page6'
        />
