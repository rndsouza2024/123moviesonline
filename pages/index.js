...
export default function HomePage () {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      ...
      '123Movies™ - Explorer. Diffuser. En ligne.',
      '123Movies™ - Entdecken. Streamen. Online.',
      '123Movies™ - 探索。串流。在线。',
      '123Movies™ - 探索する。ストリーミング。オンライン。',
      '123Movies™ - 탐험하다. 스트리밍. 온라인.',
      '123Movies™ - Explorar. Transmitir. Online.',
      '123Movies™ - Esplora. Streaming. Online.',
      '123Movies™ - Исследовать. Поток. Онлайн.',
      '123Movies™ - استكشاف. بث. اون لاين.'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel='canonical' href='https://123movies-free.vercel.app/' />
        ...
        <meta
          name='twitter:title'
          content='123Movies™ - Explore. Stream. Online.  HD Movies and TV Series Free'
        />
        <meta
      ...
      <div className='container'>
        <div className='content'>
          ...
          <Link href='/home/page1'>
            <div className='cta-button'>Enter 123Movies™</div>
          </Link>
        </div>
      </div>
