    ...
    <>
      ...
      < div className={styles.title} >
        ...
        <h1 className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-4xl hover:text-blue-800 font-bold mt-2'>
          Moviesfree™ - Online. Stream. Download.</h1>
    
          <h2 className='highlight' className={styles.title} className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-2xl hover:text-blue-800 font-bold mt-2'>

            Discover the Best Movies and TV Shows to Stream on Moviesfree™
          </h2>
          <p className='description' className={styles.description} className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-bg hover:text-blue-800 font-bold mt-2'>
          ...
          >
            <p style={{ display: 'inline-block' }} className=' title px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-bg hover:text-blue-800 font-bold mt-2'>
          ...
          <p className='subtitle' className={styles.subtitle} className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-bg hover:text-blue-800 font-bold mt-2'>
