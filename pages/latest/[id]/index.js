  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: `123Movies Online™ - Explore. Stream. Online.  Stream online HD movies with Google Translate for access in any language, worldwide.`,
        image: latest.image,
        name: ` ${latest.name} | JWF™`,
        isPartOf: {
          '@id': `/${latest['latest.watch']}#webpage`
    ...
    <div>
      <Head>
        ...
        <meta
          ...
          content='123Movies Online™ - Explore. Stream. Online.  Stream online HD movies with Google Translate for access in any language, worldwide.'
        />
