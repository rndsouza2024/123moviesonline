...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesonline.vercel.app/latest/',
  headline: 'Entertainment News | 123Movies™',
  url: 'https://123moviesonline.vercel.app/latest/',
  description:
    'Stream HD movies and TV series for free on 123Movies Online. Explore, stream, and download full-length movies and shows in HD quality without registration.',
  image: 'https://123moviesonline.vercel.app/wp-content/uploads/browser.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://123moviesonline.vercel.app/latest/'
    }
  ]
})
...
const latestPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#0e0e0e' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123moviesonline.vercel.app/latest/' />
        <meta
          name='robots'
        ...
        <meta name="keywords" content="123movies, 123moviesHUB, 123moviesFREE, 123movies-hd, 123moviesx, 123movies-org, 123movies-com, 123movies official, 123movies, 123movies free, free movies, movies online, watch movies online, watch movies free, 123movies, gomovies, putlocker, putlockers, soap2day" />
       
         <meta name="description" content="Stream HD movies and TV series for free on 123Movies Online. Explore, stream, and download full-length movies and shows in HD quality without registration."/>


        <meta
          property='og:url'
          content='https://123moviesonline.vercel.app/latest'
        />
 ...
 <SocialSharing />
      ...
      <h1
        ...
        >
        123Movies Online™ - Latest Entertainment Section.
      </h1>
      {/* <Marquee /> */}
      {/* <p
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123moviesonline.vercel.app/latest.json')
