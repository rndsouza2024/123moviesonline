...
const MoviePage = ({ movies }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'http://localhost:3000/movies/page2/#website',
        url: 'http://localhost:3000/movies/page2',
        name: '123Movies Online™ - Explore. Stream. Online. ',
        publisher: {
          '@type': 'Organization',
          '@id': 'http://localhost:3000/#organization'
      ...
      {
        '@type': 'WebPage',
        '@id': 'http://localhost:3000/movies/page2/#webpage',
        url: 'http://localhost:3000/movies/page2',
        name: 'Movie',
        ...
        mainEntity: [
          {
            '@type': 'Article',
            '@id': 'http://localhost:3000/movies/page2',
            url: 'http://localhost:3000/movies/page2',
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        />
        <link rel='canonical' href='http://localhost:3000/movies/page2' />
        ...
        />
        <meta property='og:url' content='http://localhost:3000/movies/page2' />
        <meta
