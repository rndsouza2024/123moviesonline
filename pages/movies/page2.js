...
const MoviePage = ({ movies }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'WebSite',
        '@id': 'https://123moviesonline.vercel.app/movies/page2/#website',
        url: 'https://123moviesonline.vercel.app/movies/page2',
        name: '123Movies Online™ - Explore. Stream. Online. ',
        publisher: {
          '@type': 'Organization',
          '@id': 'https://123moviesonline.vercel.app/#organization'
      ...
      {
        '@type': 'WebPage',
        '@id': 'https://123moviesonline.vercel.app/movies/page2/#webpage',
        url: 'https://123moviesonline.vercel.app/movies/page2',
        name: 'Movie',
        ...
        mainEntity: [
          {
            '@type': 'Article',
            '@id': 'https://123moviesonline.vercel.app/movies/page2',
            url: 'https://123moviesonline.vercel.app/movies/page2',
  ...
  return (
    <div>
      <Head>
        ...
        />
        <link rel='canonical' href='https://123moviesonline.vercel.app/movies/page2' />
        ...
        />
        <meta property='og:url' content='https://123moviesonline.vercel.app/movies/page2' />
        <meta
