  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Movie 36 Days (2024) | 123 Movies™</title>
        ...
        <meta
          property='og:title'
          content={`${movie && movie.name} - 123 Movies™`}
        />
        <meta
        ...
        <meta
          name='description'
          content={`${movie.title} available on 123 Movies™. Enjoy free streaming of full-length movies and TV series online with no registration required.`}
        />
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong>. At <strong>123 Movies™</strong>, we
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              than <strong>{movie.title}</strong> on <strong>123 Movies™</strong>
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              available to stream right here. At <strong>123 Movies™</strong>, we
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'watch-36-days-2024')
  return {
    props: {
      movie: selectedMovie
    }
