...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver película 36 Days (2024) | JWF™',
      'Regarder le film 36 Days (2024) | JWF™',
      'Film 36 Days (2024) ansehen | JWF™',
      '观看电影 36 Days (2024) | JWF™',
      '映画 36 Days (2024) を見る | JWF™',
      '영화 36 Days (2024) 보기 | JWF™',
      'Assistir Filme 36 Days (2024) | JWF™',
      'Guarda il film 36 Days (2024) | JWF™',
      'Посмотреть фильм 36 Days (2024) | JWF™',
