...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver película A Family Affair (2024) | JWF™',
      'Regarder le film A Family Affair (2024) | JWF™',
      'Film A Family Affair (2024) ansehen | JWF™',
      '观看电影 A Family Affair (2024) | JWF™',
      '映画 A Family Affair (2024) を見る | JWF™',
      '영화 A Family Affair (2024) 보기 | JWF™',
      'Assistir Filme A Family Affair (2024) | JWF™',
      'Guarda il film A Family Affair (2024) | JWF™',
      'Посмотреть фильм A Family Affair (2024) | JWF™',
