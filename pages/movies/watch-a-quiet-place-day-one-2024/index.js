...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver película A Quiet Place Day One (2024) | JWF™',
      'Regarder le film A Quiet Place Day One (2024) | JWF™',
      'Film A Quiet Place Day One (2024) ansehen | JWF™',
      '观看电影 A Quiet Place Day One (2024) | JWF™',
      '映画 A Quiet Place Day One (2024) を見る | JWF™',
      '영화 A Quiet Place Day One (2024) 보기 | JWF™',
      'Assistir Filme A Quiet Place Day One (2024) | JWF™',
      'Guarda il film A Quiet Place Day One (2024) | JWF™',
      'Посмотреть фильм A Quiet Place Day One (2024) | JWF™',
