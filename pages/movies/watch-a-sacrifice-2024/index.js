...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      'Ver película A Sacrifice (2024) | JWF™',
      'Regarder le film A Sacrifice (2024) | JWF™',
      'Film A Sacrifice (2024) ansehen | JWF™',
      '观看电影 A Sacrifice (2024) | JWF™',
      '映画 A Sacrifice (2024) を見る | JWF™',
      '영화 A Sacrifice (2024) 보기 | JWF™',
      'Assistir Filme A Sacrifice (2024) | JWF™',
      'Guarda il film A Sacrifice (2024) | JWF™',
      'Посмотреть фильм A Sacrifice (2024) | JWF™',
