...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Alien: Romulus (2024) | 123Movies™',
    alternateName: [
      'Ver película Alien: Romulus (2024) | 123Movies™',
      'Regarder le film Alien: Romulus (2024) | 123Movies™',
      'Film Alien: Romulus (2024) ansehen | 123Movies™',
      '观看电影 Alien: Romulus (2024) | 123Movies™',
      '映画 Alien: Romulus (2024) を見る | 123Movies™',
      '영화 Alien: Romulus (2024) 보기 | 123Movies™',
      'Assistir Filme Alien: Romulus (2024) | 123Movies™',
      'Guarda il film Alien: Romulus (2024) | 123Movies™',
      'Посмотреть фильм Alien: Romulus (2024) | 123Movies™',
      'مشاهدة فيلم Alien: Romulus (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Alien: Romulus (2024) | 123Movies™</title>
