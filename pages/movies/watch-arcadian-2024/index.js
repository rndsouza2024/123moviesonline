...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Arcadian (2024) | 123Movies™',
    alternateName: [
      'Ver película Arcadian (2024) | 123Movies™',
      'Regarder le film Arcadian (2024) | 123Movies™',
      'Film Arcadian (2024) ansehen | 123Movies™',
      '观看电影 Arcadian (2024) | 123Movies™',
      '映画 Arcadian (2024) を見る | 123Movies™',
      '영화 Arcadian (2024) 보기 | 123Movies™',
      'Assistir Filme Arcadian (2024) | 123Movies™',
      'Guarda il film Arcadian (2024) | 123Movies™',
      'Посмотреть фильм Arcadian (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Arcadian (2024) | 123Movies™</title>
