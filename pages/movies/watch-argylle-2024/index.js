...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Argylle (2024) | 123Movies™',
    alternateName: [
      'Ver película Argylle (2024) | 123Movies™',
      'Regarder le film Argylle (2024) | 123Movies™',
      'Film Argylle (2024) ansehen | 123Movies™',
      '观看电影 Argylle (2024) | 123Movies™',
      '映画 Argylle (2024) を見る | 123Movies™',
      '영화 Argylle (2024) 보기 | 123Movies™',
      'Assistir Filme Argylle (2024) | 123Movies™',
      'Guarda il film Argylle (2024) | 123Movies™',
      'Посмотреть фильм Argylle (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Argylle (2024) | 123Movies™</title>
