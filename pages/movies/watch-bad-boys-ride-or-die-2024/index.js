...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Bad Boys: Ride or Die (2024) | 123Movies™',
    alternateName: [
      'Ver película Bad Boys: Ride or Die (2024) | 123Movies™',
      'Regarder le film Bad Boys: Ride or Die (2024) | 123Movies™',
      'Film Bad Boys: Ride or Die (2024) ansehen | 123Movies™',
      '观看电影 Bad Boys: Ride or Die (2024) | 123Movies™',
      '映画 Bad Boys: Ride or Die (2024) を見る | 123Movies™',
      '영화 Bad Boys: Ride or Die (2024) 보기 | 123Movies™',
      'Assistir Filme Bad Boys: Ride or Die (2024) | 123Movies™',
      'Guarda il film Bad Boys: Ride or Die (2024) | 123Movies™',
      'Посмотреть фильм Bad Boys: Ride or Die (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bad Boys: Ride or Die (2024) | 123Movies™</title>
