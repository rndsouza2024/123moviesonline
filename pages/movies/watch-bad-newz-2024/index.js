...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Bad Newz (2024) | 123Movies™',
    alternateName: [
      'Ver película Bad Newz (2024) | 123Movies™',
      'Regarder le film Bad Newz (2024) | 123Movies™',
      'Film Bad Newz (2024) ansehen | 123Movies™',
      '观看电影 Bad Newz (2024) | 123Movies™',
      '映画 Bad Newz (2024) を見る | 123Movies™',
      '영화 Bad Newz (2024) 보기 | 123Movies™',
      'Assistir Filme Bad Newz (2024) | 123Movies™',
      'Guarda il film Bad Newz (2024) | 123Movies™',
      'Посмотреть фильм Bad Newz (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bad Newz (2024) | 123Movies™</title>
