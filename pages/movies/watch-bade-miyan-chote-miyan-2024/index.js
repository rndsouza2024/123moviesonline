...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Bade Miyan Chote Miyan (2024) | 123Movies™',
    alternateName: [
      'Ver película Bade Miyan Chote Miyan (2024) | 123Movies™',
      'Regarder le film Bade Miyan Chote Miyan (2024) | 123Movies™',
      'Film Bade Miyan Chote Miyan (2024) ansehen | 123Movies™',
      '观看电影 Bade Miyan Chote Miyan (2024) | 123Movies™',
      '映画 Bade Miyan Chote Miyan (2024) を見る | 123Movies™',
      '영화 Bade Miyan Chote Miyan (2024) 보기 | 123Movies™',
      'Assistir Filme Bade Miyan Chote Miyan (2024) | 123Movies™',
      'Guarda il film Bade Miyan Chote Miyan (2024) | 123Movies™',
      'Посмотреть фильм Bade Miyan Chote Miyan (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bade Miyan Chote Miyan (2024) | 123Movies™</title>
