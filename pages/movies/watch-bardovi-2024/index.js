...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      ...
      'Regarder le film Bardovi (2024) | 123Movies™',
      'Film Bardovi (2024) ansehen | 123Movies™',
      '观看电影 Bardovi (2024) | 123Movies™',
      '映画 Bardovi (2024) を見る | 123Movies™',
      '영화 Bardovi (2024) 보기 | 123Movies™',
      'Assistir Filme Bardovi (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bardovi (2024) | 123Movies™</title>
