...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Barzakh (2024) | 123Movies™',
    alternateName: [
      'Ver película Barzakh (2024) | 123Movies™',
      'Regarder le film Barzakh (2024) | 123Movies™',
      'Film Barzakh (2024) ansehen | 123Movies™',
      '观看电影 Barzakh (2024) | 123Movies™',
      '映画 Barzakh (2024) を見る | 123Movies™',
      '영화 Barzakh (2024) 보기 | 123Movies™',
      'Assistir Filme Barzakh (2024) | 123Movies™',
      'Guarda il film Barzakh (2024) | 123Movies™',
      'Посмотреть фильм Barzakh (2024) | 123Movies™',
      'مشاهدة فيلم Barzakh (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Barzakh (2024) | 123Movies™</title>
