...
const moviesDetail = ({ movie }) => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: ` ${movie.name} | 123 Movies™`,
        datePublished: movie.datePublished,
        dateModified: movie.dateModified,
  ...
  <title>Watch Movie Beverly Hills Cop Axel F (2024) | 123 Movies™</title>
  <link rel="canonical" href={movie && movie.siteurl} />
  <meta name="robots" content="index, follow" />
  <meta name="googlebot" content="index,follow" />
  <meta name="revisit-after" content="1 days" />
  <meta property="og:locale" content="en_US" />
  <meta property="og:title" content={`${movie && movie.name} - 123 Movies™`} />
  <meta property="og:description" content="Stream HD movies and TV series for free on 123 Movies™. Explore, stream, and download full-length movies and shows in HD quality without registration." />
  <meta name="description" content={`${movie.title} available on 123 Movies™. Enjoy free streaming of full-length movies and TV series online with no registration required.`} />
  ...
  <meta name="twitter:title" content="123 Movies™ - Explore. Discover. Online." />
  <meta name="twitter:description" content="Stream HD movies and TV series for free on 123 Movies™. Explore, stream, and download full-length movies and shows in HD quality without registration." />
  <meta name="twitter:image" content={`${movie && movie.image1}`} />
  <meta name="twitter:label1" content="Est. reading time" />
  <meta name="twitter:data1" content="1 minute" />
  <meta name="google-site-verification" content="o8uNsADswyHnNPA69n9gI7u6L4_cdjN4iT5lRhHHtMU-o8uNsADswyHnNPA69n9gI7u6L4_cdjN4iT5lRhHHtMU" />
  ...
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: ldJsonData }} />
  ...
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: newsArticleJson }} />
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: moviesSchema }} />
        ...
        {isTVShow && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong> on <strong>123 Movies™</strong> is
        ...
        {isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              <strong>{movie.title}</strong>. At <strong>123 Movies™</strong>,
        ...
        {!isTVShow && !isAdult && (
          <>
            ...
            <p className='text-lg text-yellow-500 mt-4'>
              ...
              available to stream right here. At <strong>123 Movies™</strong>,
...
export async function getServerSideProps () {
  const res = await fetch('https://123movies-free.vercel.app/moviesp5.json')
  const data = await res.json()
  const selectedMovie = data.find(
    movie => movie.id === 'watch-beverly-hills-cop-axel-f-2024'
  )
  return {
    props: {
      movie: selectedMovie
