...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Bloody Ishq (2024) | 123Movies™',
    alternateName: [
      'Ver película Bloody Ishq (2024) | 123Movies™',
      'Regarder le film Bloody Ishq (2024) | 123Movies™',
      'Film Bloody Ishq (2024) ansehen | 123Movies™',
      '观看电影 Bloody Ishq (2024) | 123Movies™',
      '映画 Bloody Ishq (2024) を見る | 123Movies™',
      '영화 Bloody Ishq (2024) 보기 | 123Movies™',
      'Assistir Filme Bloody Ishq (2024) | 123Movies™',
      'Guarda il film Bloody Ishq (2024) | 123Movies™',
      'Посмотреть фильм Bloody Ishq (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Bloody Ishq (2024) | 123Movies™</title>
