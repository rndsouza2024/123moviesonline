...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Brinda (2024) | 123Movies™',
    alternateName: [
      'Ver película Brinda (2024) | 123Movies™',
      'Regarder le film Brinda (2024) | 123Movies™',
      'Film Brinda (2024) ansehen | 123Movies™',
      '观看电影 Brinda (2024) | 123Movies™',
      '映画 Brinda (2024) を見る | 123Movies™',
      '영화 Brinda (2024) 보기 | 123Movies™',
      'Assistir Filme Brinda (2024) | 123Movies™',
      'Guarda il film Brinda (2024) | 123Movies™',
      'Посмотреть фильм Brinda (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Brinda (2024) | 123Movies™</title>
