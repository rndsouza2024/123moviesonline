...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Cadets (2024) | 123Movies™',
    alternateName: [
      'Ver película Cadets (2024) | 123Movies™',
      'Regarder le film Cadets (2024) | 123Movies™',
      'Film Cadets (2024) ansehen | 123Movies™',
      '观看电影 Cadets (2024) | 123Movies™',
      '映画 Cadets (2024) を見る | 123Movies™',
      '영화 Cadets (2024) 보기 | 123Movies™',
      'Assistir Filme Cadets (2024) | 123Movies™',
      'Guarda il film Cadets (2024) | 123Movies™',
      'Посмотреть фильм Cadets (2024) | 123Movies™',
      'مشاهدة فيلم Cadets (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Cadets (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-cadets-2024'
  )
  return {
    props: {
      movie: selectedMovie
