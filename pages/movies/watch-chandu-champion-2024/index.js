...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Chandu Champion (2024) | 123Movies™',
    alternateName: [
      'Ver película Chandu Champion (2024) | 123Movies™',
      'Regarder le film Chandu Champion (2024) | 123Movies™',
      'Film Chandu Champion (2024) ansehen | 123Movies™',
      '观看电影 Chandu Champion (2024) | 123Movies™',
      '映画 Chandu Champion (2024) を見る | 123Movies™',
      '영화 Chandu Champion (2024) 보기 | 123Movies™',
      'Assistir Filme Chandu Champion (2024) | 123Movies™',
      'Guarda il film Chandu Champion (2024) | 123Movies™',
      'Посмотреть фильм Chandu Champion (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Chandu Champion (2024) | 123Movies™</title>
