...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Charlie Tango (2024) | 123Movies™',
    alternateName: [
      'Ver película Charlie Tango (2024) | 123Movies™',
      'Regarder le film Charlie Tango (2024) | 123Movies™',
      'Film Charlie Tango (2024) ansehen | 123Movies™',
      '观看电影 Charlie Tango (2024) | 123Movies™',
      '映画 Charlie Tango (2024) を見る | 123Movies™',
      '영화 Charlie Tango (2024) 보기 | 123Movies™',
      'Assistir Filme Charlie Tango (2024) | 123Movies™',
      'Guarda il film Charlie Tango (2024) | 123Movies™',
      'Посмотреть фильм Charlie Tango (2024) | 123Movies™',
      'مشاهدة فيلم Charlie Tango (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Charlie Tango (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-charlie-tango-2024'
  )
  return {
    props: {
      movie: selectedMovie
