...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Continental Split (2024) | 123Movies™',
    alternateName: [
      'Ver película Continental Split (2024) | 123Movies™',
      'Regarder le film Continental Split (2024) | 123Movies™',
      'Film Continental Split (2024) ansehen | 123Movies™',
      '观看电影 Continental Split (2024) | 123Movies™',
      '映画 Continental Split (2024) を見る | 123Movies™',
      '영화 Continental Split (2024) 보기 | 123Movies™',
      'Assistir Filme Continental Split (2024) | 123Movies™',
      'Guarda il film Continental Split (2024) | 123Movies™',
      'Посмотреть фильм Continental Split (2024) | 123Movies™',
      'مشاهدة فيلم Continental Split (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Continental Split (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-continental-split-2024'
  )
  return {
    props: {
      movie: selectedMovie
