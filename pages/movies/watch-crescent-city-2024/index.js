...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Crescent City (2024) | 123Movies™',
    alternateName: [
      'Ver película Crescent City (2024) | 123Movies™',
      'Regarder le film Crescent City (2024) | 123Movies™',
      'Film Crescent City (2024) ansehen | 123Movies™',
      '观看电影 Crescent City (2024) | 123Movies™',
      '映画 Crescent City (2024) を見る | 123Movies™',
      '영화 Crescent City (2024) 보기 | 123Movies™',
      'Assistir Filme Crescent City (2024) | 123Movies™',
      'Guarda il film Crescent City (2024) | 123Movies™',
      'Посмотреть фильм Crescent City (2024) | 123Movies™',
      'مشاهدة فيلم Crescent City (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Crescent City (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-crescent-city-2024'
  )
  return {
    props: {
      movie: selectedMovie
