...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Daddio (2024) | 123Movies™',
    alternateName: [
      'Ver película Daddio (2024) | 123Movies™',
      'Regarder le film Daddio (2024) | 123Movies™',
      'Film Daddio (2024) ansehen | 123Movies™',
      '观看电影 Daddio (2024) | 123Movies™',
      '映画 Daddio (2024) を見る | 123Movies™',
      '영화 Daddio (2024) 보기 | 123Movies™',
      'Assistir Filme Daddio (2024) | 123Movies™',
      'Guarda il film Daddio (2024) | 123Movies™',
      'Посмотреть фильм Daddio (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Daddio (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-daddio-2024'
  )
  return {
    props: {
      movie: selectedMovie
