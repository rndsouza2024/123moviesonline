...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Dead Sea (2024) | 123Movies™',
    alternateName: [
      'Ver película Dead Sea (2024) | 123Movies™',
      'Regarder le film Dead Sea (2024) | 123Movies™',
      'Film Dead Sea (2024) ansehen | 123Movies™',
      '观看电影 Dead Sea (2024) | 123Movies™',
      '映画 Dead Sea (2024) を見る | 123Movies™',
      '영화 Dead Sea (2024) 보기 | 123Movies™',
      'Assistir Filme Dead Sea (2024) | 123Movies™',
      'Guarda il film Dead Sea (2024) | 123Movies™',
      'Посмотреть фильм Dead Sea (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Dead Sea (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-dead-sea-2024'
  )
  return {
    props: {
      movie: selectedMovie
