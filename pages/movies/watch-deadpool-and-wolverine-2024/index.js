...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Deadpool & Wolverine (2024) | 123Movies™',
    alternateName: [
      'Ver película Deadpool & Wolverine (2024) | 123Movies™',
      'Regarder le film Deadpool & Wolverine (2024) | 123Movies™',
      'Film Deadpool & Wolverine (2024) ansehen | 123Movies™',
      '观看电影 Deadpool & Wolverine (2024) | 123Movies™',
      '映画 Deadpool & Wolverine (2024) を見る | 123Movies™',
      '영화 Deadpool & Wolverine (2024) 보기 | 123Movies™',
      'Assistir Filme Deadpool & Wolverine (2024) | 123Movies™',
      'Guarda il film Deadpool & Wolverine (2024) | 123Movies™',
      'Посмотреть фильм Deadpool & Wolverine (2024) | 123Movies™',
      'مشاهدة فيلم Deadpool & Wolverine (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Deadpool & Wolverine (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-deadpool-and-wolverine-2024'
  )
  return {
    props: {
      movie: selectedMovie
