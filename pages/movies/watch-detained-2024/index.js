...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Detained (2024) | 123Movies™',
    alternateName: [
      'Ver película Detained (2024) | 123Movies™',
      'Regarder le film Detained (2024) | 123Movies™',
      'Film Detained (2024) ansehen | 123Movies™',
      '观看电影 Detained (2024) | 123Movies™',
      '映画 Detained (2024) を見る | 123Movies™',
      '영화 Detained (2024) 보기 | 123Movies™',
      'Assistir Filme Detained (2024) | 123Movies™',
      'Guarda il film Detained (2024) | 123Movies™',
      'Посмотреть фильм Detained (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Detained (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-detained-2024'
  )
  return {
    props: {
      movie: selectedMovie
