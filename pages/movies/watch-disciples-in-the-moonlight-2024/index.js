...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Disciples in the Moonlight (2024) | 123Movies™',
    alternateName: [
      'Ver película Disciples in the Moonlight (2024) | 123Movies™',
      'Regarder le film Disciples in the Moonlight (2024) | 123Movies™',
      'Film Disciples in the Moonlight (2024) ansehen | 123Movies™',
      '观看电影 Disciples in the Moonlight (2024) | 123Movies™',
      '映画 Disciples in the Moonlight (2024) を見る | 123Movies™',
      '영화 Disciples in the Moonlight (2024) 보기 | 123Movies™',
      'Assistir Filme Disciples in the Moonlight (2024) | 123Movies™',
      'Guarda il film Disciples in the Moonlight (2024) | 123Movies™',
      'Посмотреть фильм Disciples in the Moonlight (2024) | 123Movies™',
      'مشاهدة فيلم Disciples in the Moonlight (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Disciples in the Moonlight (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-disciples-in-the-moonlight-2024'
  )
  return {
    props: {
      movie: selectedMovie
