...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Doom Collection (2024) | 123Movies™',
    alternateName: [
      'Ver película Doom Collection (2024) | 123Movies™',
      'Regarder le film Doom Collection (2024) | 123Movies™',
      'Film Doom Collection (2024) ansehen | 123Movies™',
      '观看电影 Doom Collection (2024) | 123Movies™',
      '映画 Doom Collection (2024) を見る | 123Movies™',
      '영화 Doom Collection (2024) 보기 | 123Movies™',
      'Assistir Filme Doom Collection (2024) | 123Movies™',
      'Guarda il film Doom Collection (2024) | 123Movies™',
      'Посмотреть фильм Doom Collection (2024) | 123Movies™',
      'مشاهدة فيلم Doom Collection (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Doom Collection (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-doom-collection-movies'
  )
  return {
    props: {
      movie: selectedMovie
