...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Double Ismart (2024) | 123Movies™',
    alternateName: [
      'Ver película Double Ismart (2024) | 123Movies™',
      'Regarder le film Double Ismart (2024) | 123Movies™',
      'Film Double Ismart (2024) ansehen | 123Movies™',
      '观看电影 Double Ismart (2024) | 123Movies™',
      '映画 Double Ismart (2024) を見る | 123Movies™',
      '영화 Double Ismart (2024) 보기 | 123Movies™',
      'Assistir Filme Double Ismart (2024) | 123Movies™',
      'Guarda il film Double Ismart (2024) | 123Movies™',
      'Посмотреть фильм Double Ismart (2024) | 123Movies™',
      'مشاهدة فيلم Double Ismart (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Double Ismart (2024) | 123Movies™</title>
