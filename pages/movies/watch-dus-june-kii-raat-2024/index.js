...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Dus June Kii Raat (2024) | 123Movies™',
    alternateName: [
      'Ver película Dus June Kii Raat (2024) | 123Movies™',
      'Regarder le film Dus June Kii Raat (2024) | 123Movies™',
      'Film Dus June Kii Raat (2024) ansehen | 123Movies™',
      '观看电影 Dus June Kii Raat (2024) | 123Movies™',
      '映画 Dus June Kii Raat (2024) を見る | 123Movies™',
      '영화 Dus June Kii Raat (2024) 보기 | 123Movies™',
      'Assistir Filme Dus June Kii Raat (2024) | 123Movies™',
      'Guarda il film Dus June Kii Raat (2024) | 123Movies™',
      'Посмотреть фильм Dus June Kii Raat (2024) | 123Movies™',
      'مشاهدة فيلم Dus June Kii Raat (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Dus June Kii Raat (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-dus-june-kii-raat-2024'
  )
  return {
    props: {
      movie: selectedMovie
