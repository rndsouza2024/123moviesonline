...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Escape From Germany (2024) | 123Movies™',
    alternateName: [
      'Ver película Escape From Germany (2024) | 123Movies™',
      'Regarder le film Escape From Germany (2024) | 123Movies™',
      'Film Escape From Germany (2024) ansehen | 123Movies™',
      '观看电影 Escape From Germany (2024) | 123Movies™',
      '映画 Escape From Germany (2024) を見る | 123Movies™',
      '영화 Escape From Germany (2024) 보기 | 123Movies™',
      'Assistir Filme Escape From Germany (2024) | 123Movies™',
      'Guarda il film Escape From Germany (2024) | 123Movies™',
      'Посмотреть фильм Escape From Germany (2024) | 123Movies™',
      'مشاهدة فيلم Escape From Germany (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Escape From Germany (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-escape-from-germany-2024'
  )
  return {
    props: {
      movie: selectedMovie
