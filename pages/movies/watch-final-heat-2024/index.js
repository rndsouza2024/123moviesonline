...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Final Heat (2024) | 123Movies™',
    alternateName: [
      'Ver película Final Heat (2024) | 123Movies™',
      'Regarder le film Final Heat (2024) | 123Movies™',
      'Film Final Heat (2024) ansehen | 123Movies™',
      '观看电影 Final Heat (2024) | 123Movies™',
      '映画 Final Heat (2024) を見る | 123Movies™',
      '영화 Final Heat (2024) 보기 | 123Movies™',
      'Assistir Filme Final Heat (2024) | 123Movies™',
      'Guarda il film Final Heat (2024) | 123Movies™',
      'Посмотреть фильм Final Heat (2024) | 123Movies™',
      'مشاهدة فيلم Final Heat (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Final Heat (2024) | 123Movies™</title>
