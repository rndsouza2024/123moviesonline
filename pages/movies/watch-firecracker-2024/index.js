...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Firecracker (2024) | 123Movies™',
    alternateName: [
      'Ver película Firecracker (2024) | 123Movies™',
      'Regarder le film Firecracker (2024) | 123Movies™',
      'Film Firecracker (2024) ansehen | 123Movies™',
      '观看电影 Firecracker (2024) | 123Movies™',
      '映画 Firecracker (2024) を見る | 123Movies™',
      '영화 Firecracker (2024) 보기 | 123Movies™',
      'Assistir Filme Firecracker (2024) | 123Movies™',
      'Guarda il film Firecracker (2024) | 123Movies™',
      'Посмотреть фильм Firecracker (2024) | 123Movies™',
      'مشاهدة فيلم Firecracker (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Firecracker (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-firecracker-2024'
  )
  return {
    props: {
      movie: selectedMovie
