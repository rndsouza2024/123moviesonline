...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie First Shift (2024) | 123Movies™',
    alternateName: [
      'Ver película First Shift (2024) | 123Movies™',
      'Regarder le film First Shift (2024) | 123Movies™',
      'Film First Shift (2024) ansehen | 123Movies™',
      '观看电影 First Shift (2024) | 123Movies™',
      '映画 First Shift (2024) を見る | 123Movies™',
      '영화 First Shift (2024) 보기 | 123Movies™',
      'Assistir Filme First Shift (2024) | 123Movies™',
      'Guarda il film First Shift (2024) | 123Movies™',
      'Посмотреть фильм First Shift (2024) | 123Movies™',
      'مشاهدة فيلم First Shift (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie First Shift (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-first-shift-2024'
  )
  return {
    props: {
      movie: selectedMovie
