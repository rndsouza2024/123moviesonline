...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Flight Attendant (2024) | 123Movies™',
    alternateName: [
      'Ver película Flight Attendant (2024) | 123Movies™',
      'Regarder le film Flight Attendant (2024) | 123Movies™',
      'Film Flight Attendant (2024) ansehen | 123Movies™',
      '观看电影 Flight Attendant (2024) | 123Movies™',
      '映画 Flight Attendant (2024) を見る | 123Movies™',
      '영화 Flight Attendant (2024) 보기 | 123Movies™',
      'Assistir Filme Flight Attendant (2024) | 123Movies™',
      'Guarda il film Flight Attendant (2024) | 123Movies™',
      'Посмотреть фильм Flight Attendant (2024) | 123Movies™',
      'مشاهدة فيلم Flight Attendant (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Flight Attendant (2024) | 123Movies™</title>
