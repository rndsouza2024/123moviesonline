...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Gangs Of Godavari (2024) | 123Movies™',
    alternateName: [
      'Ver película Gangs Of Godavari (2024) | 123Movies™',
      'Regarder le film Gangs Of Godavari (2024) | 123Movies™',
      'Film Gangs Of Godavari (2024) ansehen | 123Movies™',
      '观看电影 Gangs Of Godavari (2024) | 123Movies™',
      '映画 Gangs Of Godavari (2024) を見る | 123Movies™',
      '영화 Gangs Of Godavari (2024) 보기 | 123Movies™',
      'Assistir Filme Gangs Of Godavari (2024) | 123Movies™',
      'Guarda il film Gangs Of Godavari (2024) | 123Movies™',
      'Посмотреть фильм Gangs Of Godavari (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Gangs Of Godavari (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-gangs-of-godavari-2024'
  )
  return {
    props: {
      movie: selectedMovie
