...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    alternateName: [
      ...
      'Regarder le film Ghudchadi (2024) | 123Movies™',
      'Film Ghudchadi (2024) ansehen | 123Movies™',
      '观看电影 Ghudchadi (2024) | 123Movies™',
      '映画 Ghudchadi (2024) を見る | 123Movies™',
      '영화 Ghudchadi (2024) 보기 | 123Movies™',
      'Assistir Filme Ghudchadi (2024) | 123Movies™',
      'Guarda il film Ghudchadi (2024) | 123Movies™',
      'Посмотреть фильм Ghudchadi (2024) | 123Movies™',
      'مشاهدة فيلم Ghudchadi (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Ghudchadi (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-ghudchadi-2024'
  )
  return {
    props: {
      movie: selectedMovie
