...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Gunner (2024) | 123Movies™',
    alternateName: [
      'Ver película Gunner (2024) | 123Movies™',
      'Regarder le film Gunner (2024) | 123Movies™',
      'Film Gunner (2024) ansehen | 123Movies™',
      '观看电影 Gunner (2024) | 123Movies™',
      '映画 Gunner (2024) を見る | 123Movies™',
      '영화 Gunner (2024) 보기 | 123Movies™',
      'Assistir Filme Gunner (2024) | 123Movies™',
      'Guarda il film Gunner (2024) | 123Movies™',
      'Посмотреть фильм Gunner (2024) | 123Movies™',
      'مشاهدة فيلم Gunner (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Gunner (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-gunner-2024'
  )
  return {
    props: {
      movie: selectedMovie
