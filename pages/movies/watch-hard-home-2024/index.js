...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Hard Home (2024) | 123Movies™',
    alternateName: [
      'Ver película Hard Home (2024) | 123Movies™',
      'Regarder le film Hard Home (2024) | 123Movies™',
      'Film Hard Home (2024) ansehen | 123Movies™',
      '观看电影 Hard Home (2024) | 123Movies™',
      '映画 Hard Home (2024) を見る | 123Movies™',
      '영화 Hard Home (2024) 보기 | 123Movies™',
      'Assistir Filme Hard Home (2024) | 123Movies™',
      'Guarda il film Hard Home (2024) | 123Movies™',
      'Посмотреть фильм Hard Home (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Hard Home (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-hard-home-2024'
  )
  return {
    props: {
      movie: selectedMovie
