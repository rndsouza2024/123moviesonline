...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Harold and the Purple Crayon (2024) | 123Movies™',
    alternateName: [
      'Ver película Harold and the Purple Crayon (2024) | 123Movies™',
      'Regarder le film Harold and the Purple Crayon (2024) | 123Movies™',
      'Film Harold and the Purple Crayon (2024) ansehen | 123Movies™',
      '观看电影 Harold and the Purple Crayon (2024) | 123Movies™',
      '映画 Harold and the Purple Crayon (2024) を見る | 123Movies™',
      '영화 Harold and the Purple Crayon (2024) 보기 | 123Movies™',
      'Assistir Filme Harold and the Purple Crayon (2024) | 123Movies™',
      'Guarda il film Harold and the Purple Crayon (2024) | 123Movies™',
      'Посмотреть фильм Harold and the Purple Crayon (2024) | 123Movies™',
      'مشاهدة فيلم Harold and the Purple Crayon (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Harold and the Purple Crayon (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-harold-and-the-purple-crayon-2024'
  )
  return {
    props: {
      movie: selectedMovie
