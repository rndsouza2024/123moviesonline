...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Harom Hara (2024) | 123Movies™',
    alternateName: [
      'Ver película Harom Hara (2024) | 123Movies™',
      'Regarder le film Harom Hara (2024) | 123Movies™',
      'Film Harom Hara (2024) ansehen | 123Movies™',
      '观看电影 Harom Hara (2024) | 123Movies™',
      '映画 Harom Hara (2024) を見る | 123Movies™',
      '영화 Harom Hara (2024) 보기 | 123Movies™',
      'Assistir Filme Harom Hara (2024) | 123Movies™',
      'Guarda il film Harom Hara (2024) | 123Movies™',
      'Посмотреть фильм Harom Hara (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Harom Hara (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-harom-hara-2024'
  )
  return {
    props: {
      movie: selectedMovie
