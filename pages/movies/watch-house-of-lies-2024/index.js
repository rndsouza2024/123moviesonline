...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie House Of Lies (2024) | 123Movies™',
    alternateName: [
      'Ver película House Of Lies (2024) | 123Movies™',
      'Regarder le film House Of Lies (2024) | 123Movies™',
      'Film House Of Lies (2024) ansehen | 123Movies™',
      '观看电影 House Of Lies (2024) | 123Movies™',
      '映画 House Of Lies (2024) を見る | 123Movies™',
      '영화 House Of Lies (2024) 보기 | 123Movies™',
      'Assistir Filme House Of Lies (2024) | 123Movies™',
      'Guarda il film House Of Lies (2024) | 123Movies™',
      'Посмотреть фильм House Of Lies (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie House Of Lies (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-house-of-lies-2024'
  )
  return {
    props: {
      movie: selectedMovie
