...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie In a Violent Nature (2024) | 123Movies™',
    alternateName: [
      'Ver película In a Violent Nature (2024) | 123Movies™',
      'Regarder le film In a Violent Nature (2024) | 123Movies™',
      'Film In a Violent Nature (2024) ansehen | 123Movies™',
      '观看电影 In a Violent Nature (2024) | 123Movies™',
      '映画 In a Violent Nature (2024) を見る | 123Movies™',
      '영화 In a Violent Nature (2024) 보기 | 123Movies™',
      'Assistir Filme In a Violent Nature (2024) | 123Movies™',
      'Guarda il film In a Violent Nature (2024) | 123Movies™',
      'Посмотреть фильм In a Violent Nature (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie In a Violent Nature (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-in-a-violent-nature-2024'
  )
  return {
    props: {
      movie: selectedMovie
