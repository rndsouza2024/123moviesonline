...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Incoming (2024) | 123Movies™',
    alternateName: [
      'Ver película Incoming (2024) | 123Movies™',
      'Regarder le film Incoming (2024) | 123Movies™',
      'Film Incoming (2024) ansehen | 123Movies™',
      '观看电影 Incoming (2024) | 123Movies™',
      '映画 Incoming (2024) を見る | 123Movies™',
      '영화 Incoming (2024) 보기 | 123Movies™',
      'Assistir Filme Incoming (2024) | 123Movies™',
      'Guarda il film Incoming (2024) | 123Movies™',
      'Посмотреть фильм Incoming (2024) | 123Movies™',
      'مشاهدة فيلم Incoming (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Incoming (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-incoming-2024'
  )
  return {
    props: {
      movie: selectedMovie
