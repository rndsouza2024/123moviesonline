...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Indian 2 (2024) | 123Movies™',
    alternateName: [
      'Ver película Indian 2 (2024) | 123Movies™',
      'Regarder le film Indian 2 (2024) | 123Movies™',
      'Film Indian 2 (2024) ansehen | 123Movies™',
      '观看电影 Indian 2 (2024) | 123Movies™',
      '映画 Indian 2 (2024) を見る | 123Movies™',
      '영화 Indian 2 (2024) 보기 | 123Movies™',
      'Assistir Filme Indian 2 (2024) | 123Movies™',
      'Guarda il film Indian 2 (2024) | 123Movies™',
      'Посмотреть фильм Indian 2 (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Indian 2 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-indian-2-2024'
  )
  return {
    props: {
      movie: selectedMovie
