...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie John Wick Chapter 4 (2024) | 123Movies™',
    alternateName: [
      'Ver película John Wick Chapter 4 (2024) | 123Movies™',
      'Regarder le film John Wick Chapter 4 (2024) | 123Movies™',
      'Film John Wick Chapter 4 (2024) ansehen | 123Movies™',
      '观看电影 John Wick Chapter 4 (2024) | 123Movies™',
      '映画 John Wick Chapter 4 (2024) を見る | 123Movies™',
      '영화 John Wick Chapter 4 (2024) 보기 | 123Movies™',
      'Assistir Filme John Wick Chapter 4 (2024) | 123Movies™',
      'Guarda il film John Wick Chapter 4 (2024) | 123Movies™',
      'Посмотреть фильм John Wick Chapter 4 (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie John Wick Chapter 4 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-john-wick-chapter-4-2023'
  )
  return {
    props: {
      movie: selectedMovie
