...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kaagaz 2 (2024) | 123Movies™',
    alternateName: [
      'Ver película Kaagaz 2 (2024) | 123Movies™',
      'Regarder le film Kaagaz 2 (2024) | 123Movies™',
      'Film Kaagaz 2 (2024) ansehen | 123Movies™',
      '观看电影 Kaagaz 2 (2024) | 123Movies™',
      '映画 Kaagaz 2 (2024) を見る | 123Movies™',
      '영화 Kaagaz 2 (2024) 보기 | 123Movies™',
      'Assistir Filme Kaagaz 2 (2024) | 123Movies™',
      'Guarda il film Kaagaz 2 (2024) | 123Movies™',
      'Посмотреть фильм Kaagaz 2 (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kaagaz 2 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-kaagaz-2-2024'
  )
  return {
    props: {
      movie: selectedMovie
