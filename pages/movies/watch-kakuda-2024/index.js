...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kakuda (2024) | 123Movies™',
    alternateName: [
      'Ver película Kakuda (2024) | 123Movies™',
      'Regarder le film Kakuda (2024) | 123Movies™',
      'Film Kakuda (2024) ansehen | 123Movies™',
      '观看电影 Kakuda (2024) | 123Movies™',
      '映画 Kakuda (2024) を見る | 123Movies™',
      '영화 Kakuda (2024) 보기 | 123Movies™',
      'Assistir Filme Kakuda (2024) | 123Movies™',
      'Guarda il film Kakuda (2024) | 123Movies™',
      'Посмотреть фильм Kakuda (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kakuda (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-kakuda-2024'
  )
  return {
    props: {
      movie: selectedMovie
