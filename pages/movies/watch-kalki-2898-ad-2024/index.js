...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kalki 2898 AD (2024) | 123Movies™',
    alternateName: [
      'Ver película Kalki 2898 AD (2024) | 123Movies™',
      'Regarder le film Kalki 2898 AD (2024) | 123Movies™',
      'Film Kalki 2898 AD (2024) ansehen | 123Movies™',
      '观看电影 Kalki 2898 AD (2024) | 123Movies™',
      '映画 Kalki 2898 AD (2024) を見る | 123Movies™',
      '영화 Kalki 2898 AD (2024) 보기 | 123Movies™',
      'Assistir Filme Kalki 2898 AD (2024) | 123Movies™',
      'Guarda il film Kalki 2898 AD (2024) | 123Movies™',
      'Посмотреть фильм Kalki 2898 AD (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kalki 2898 AD (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-kalki-2898-ad-2024'
  )
  return {
    props: {
      movie: selectedMovie
