...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Kill (2024) | 123Movies™',
    alternateName: [
      'Ver película Kill (2024) | 123Movies™',
      'Regarder le film Kill (2024) | 123Movies™',
      'Film Kill (2024) ansehen | 123Movies™',
      '观看电影 Kill (2024) | 123Movies™',
      '映画 Kill (2024) を見る | 123Movies™',
      '영화 Kill (2024) 보기 | 123Movies™',
      'Assistir Filme Kill (2024) | 123Movies™',
      'Guarda il film Kill (2024) | 123Movies™',
      'Посмотреть фильм Kill (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Kill (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-kill-2024'
  )
  return {
    props: {
      movie: selectedMovie
