...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Latency (2024) | 123Movies™',
    alternateName: [
      'Ver película Latency (2024) | 123Movies™',
      'Regarder le film Latency (2024) | 123Movies™',
      'Film Latency (2024) ansehen | 123Movies™',
      '观看电影 Latency (2024) | 123Movies™',
      '映画 Latency (2024) を見る | 123Movies™',
      '영화 Latency (2024) 보기 | 123Movies™',
      'Assistir Filme Latency (2024) | 123Movies™',
      'Guarda il film Latency (2024) | 123Movies™',
      'Посмотреть фильм Latency (2024) | 123Movies™',
      'مشاهدة فيلم Latency (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Latency (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-latency-2024'
  )
  return {
    props: {
      movie: selectedMovie
