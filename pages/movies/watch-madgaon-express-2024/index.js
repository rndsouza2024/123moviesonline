...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Madgaon Express (2024) | 123Movies™',
    alternateName: [
      'Ver película Madgaon Express (2024) | 123Movies™',
      'Regarder le film Madgaon Express (2024) | 123Movies™',
      'Film Madgaon Express (2024) ansehen | 123Movies™',
      '观看电影 Madgaon Express (2024) | 123Movies™',
      '映画 Madgaon Express (2024) を見る | 123Movies™',
      '영화 Madgaon Express (2024) 보기 | 123Movies™',
      'Assistir Filme Madgaon Express (2024) | 123Movies™',
      'Guarda il film Madgaon Express (2024) | 123Movies™',
      'Посмотреть фильм Madgaon Express (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Madgaon Express (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-madgaon-express-2024'
  )
  return {
    props: {
      movie: selectedMovie
