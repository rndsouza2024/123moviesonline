...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Maidaan (2024) | JWF™',
    alternateName: [
      'Ver película Maidaan (2024) | JWF™',
      'Regarder le film Maidaan (2024) | JWF™',
      'Film Maidaan (2024) ansehen | JWF™',
      '观看电影 Maidaan (2024) | JWF™',
      '映画 Maidaan (2024) を見る | JWF™',
      '영화 Maidaan (2024) 보기 | JWF™',
      'Assistir Filme Maidaan (2024) | JWF™',
      'Guarda il film Maidaan (2024) | JWF™',
      'Посмотреть фильм Maidaan (2024) | JWF™',
