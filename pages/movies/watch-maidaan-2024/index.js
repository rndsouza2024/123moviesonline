...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Maidaan (2024) | 123Movies™',
    alternateName: [
      'Ver película Maidaan (2024) | 123Movies™',
      'Regarder le film Maidaan (2024) | 123Movies™',
      'Film Maidaan (2024) ansehen | 123Movies™',
      '观看电影 Maidaan (2024) | 123Movies™',
      '映画 Maidaan (2024) を見る | 123Movies™',
      '영화 Maidaan (2024) 보기 | 123Movies™',
      'Assistir Filme Maidaan (2024) | 123Movies™',
      'Guarda il film Maidaan (2024) | 123Movies™',
      'Посмотреть фильм Maidaan (2024) | 123Movies™',
      'مشاهدة فيلم Maidaan (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Maidaan (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-maidaan-2024'
  )
  return {
    props: {
      movie: selectedMovie
