...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie MaXXXine (2024) | 123Movies™',
    alternateName: [
      'Ver película MaXXXine (2024) | 123Movies™',
      'Regarder le film MaXXXine (2024) | 123Movies™',
      'Film MaXXXine (2024) ansehen | 123Movies™',
      '观看电影 MaXXXine (2024) | 123Movies™',
      '映画 MaXXXine (2024) を見る | 123Movies™',
      '영화 MaXXXine (2024) 보기 | 123Movies™',
      'Assistir Filme MaXXXine (2024) | 123Movies™',
      'Guarda il film MaXXXine (2024) | 123Movies™',
      'Посмотреть фильм MaXXXine (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie MaXXXine (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-maxxxine-2024'
  )
  return {
    props: {
      movie: selectedMovie
