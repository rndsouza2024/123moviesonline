...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Mission: Cross (2024) | 123Movies™',
    alternateName: [
      'Ver película Mission: Cross (2024) | 123Movies™',
      'Regarder le film Mission: Cross (2024) | 123Movies™',
      'Film Mission: Cross (2024) ansehen | 123Movies™',
      '观看电影 Mission: Cross (2024) | 123Movies™',
      '映画 Mission: Cross (2024) を見る | 123Movies™',
      '영화 Mission: Cross (2024) 보기 | 123Movies™',
      'Assistir Filme Mission: Cross (2024) | 123Movies™',
      'Guarda il film Mission: Cross (2024) | 123Movies™',
      'Посмотреть фильм Mission: Cross (2024) | 123Movies™',
      'مشاهدة فيلم Mission: Cross (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Mission: Cross (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-mission-cross-2024'
  )
  return {
    props: {
      movie: selectedMovie
