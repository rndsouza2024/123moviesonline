...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Mr And Mrs Mahi (2024) | 123Movies™',
    alternateName: [
      'Ver película Mr And Mrs Mahi (2024) | 123Movies™',
      'Regarder le film Mr And Mrs Mahi (2024) | 123Movies™',
      'Film Mr And Mrs Mahi (2024) ansehen | 123Movies™',
      '观看电影 Mr And Mrs Mahi (2024) | 123Movies™',
      '映画 Mr And Mrs Mahi (2024) を見る | 123Movies™',
      '영화 Mr And Mrs Mahi (2024) 보기 | 123Movies™',
      'Assistir Filme Mr And Mrs Mahi (2024) | 123Movies™',
      'Guarda il film Mr And Mrs Mahi (2024) | 123Movies™',
      'Посмотреть фильм Mr And Mrs Mahi (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Mr And Mrs Mahi (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-mr-and-mrs-mahi-2024'
  )
  return {
    props: {
      movie: selectedMovie
