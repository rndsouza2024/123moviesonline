...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Murder Mubarak (2024) | 123Movies™',
    alternateName: [
      'Ver película Murder Mubarak (2024) | 123Movies™',
      'Regarder le film Murder Mubarak (2024) | 123Movies™',
      'Film Murder Mubarak (2024) ansehen | 123Movies™',
      '观看电影 Murder Mubarak (2024) | 123Movies™',
      '映画 Murder Mubarak (2024) を見る | 123Movies™',
      '영화 Murder Mubarak (2024) 보기 | 123Movies™',
      'Assistir Filme Murder Mubarak (2024) | 123Movies™',
      'Guarda il film Murder Mubarak (2024) | 123Movies™',
      'Посмотреть фильм Murder Mubarak (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Murder Mubarak (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-murder-mubarak-2024'
  )
  return {
    props: {
      movie: selectedMovie
