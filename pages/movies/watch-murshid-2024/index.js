...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Murshid (2024) | 123Movies™',
    alternateName: [
      'Ver película Murshid (2024) | 123Movies™',
      'Regarder le film Murshid (2024) | 123Movies™',
      'Film Murshid (2024) ansehen | 123Movies™',
      '观看电影 Murshid (2024) | 123Movies™',
      '映画 Murshid (2024) を見る | 123Movies™',
      '영화 Murshid (2024) 보기 | 123Movies™',
      'Assistir Filme Murshid (2024) | 123Movies™',
      'Guarda il film Murshid (2024) | 123Movies™',
      'Посмотреть фильм Murshid (2024) | 123Movies™',
      'مشاهدة فيلم Murshid (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Murshid (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-murshid-2024'
  )
  return {
    props: {
      movie: selectedMovie
