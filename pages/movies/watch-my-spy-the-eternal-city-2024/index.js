...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie My Spy the Eternal City (2024) | 123Movies™',
    alternateName: [
      'Ver película My Spy the Eternal City (2024) | 123Movies™',
      'Regarder le film My Spy the Eternal City (2024) | 123Movies™',
      'Film My Spy the Eternal City (2024) ansehen | 123Movies™',
      '观看电影 My Spy the Eternal City (2024) | 123Movies™',
      '映画 My Spy the Eternal City (2024) を見る | 123Movies™',
      '영화 My Spy the Eternal City (2024) 보기 | 123Movies™',
      'Assistir Filme My Spy the Eternal City (2024) | 123Movies™',
      'Guarda il film My Spy the Eternal City (2024) | 123Movies™',
      'Посмотреть фильм My Spy the Eternal City (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie My Spy the Eternal City (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-my-spy-the-eternal-city-2024'
  )
  return {
    props: {
      movie: selectedMovie
