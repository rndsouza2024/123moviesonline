...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Peter Five Eight (2024) | 123Movies™',
    alternateName: [
      'Ver película Peter Five Eight (2024) | 123Movies™',
      'Regarder le film Peter Five Eight (2024) | 123Movies™',
      'Film Peter Five Eight (2024) ansehen | 123Movies™',
      '观看电影 Peter Five Eight (2024) | 123Movies™',
      '映画 Peter Five Eight (2024) を見る | 123Movies™',
      '영화 Peter Five Eight (2024) 보기 | 123Movies™',
      'Assistir Filme Peter Five Eight (2024) | 123Movies™',
      'Guarda il film Peter Five Eight (2024) | 123Movies™',
      'Посмотреть фильм Peter Five Eight (2024) | 123Movies™',
      'مشاهدة فيلم Peter Five Eight (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Peter Five Eight (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-peter-five-eight-2024'
  )
  return {
    props: {
      movie: selectedMovie
