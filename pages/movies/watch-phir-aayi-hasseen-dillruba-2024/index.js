...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Phir Aayi Hasseen Dillruba (2024) | 123Movies™',
    alternateName: [
      'Ver película Phir Aayi Hasseen Dillruba (2024) | 123Movies™',
      'Regarder le film Phir Aayi Hasseen Dillruba (2024) | 123Movies™',
      'Film Phir Aayi Hasseen Dillruba (2024) ansehen | 123Movies™',
      '观看电影 Phir Aayi Hasseen Dillruba (2024) | 123Movies™',
      '映画 Phir Aayi Hasseen Dillruba (2024) を見る | 123Movies™',
      '영화 Phir Aayi Hasseen Dillruba (2024) 보기 | 123Movies™',
      'Assistir Filme Phir Aayi Hasseen Dillruba (2024) | 123Movies™',
      'Guarda il film Phir Aayi Hasseen Dillruba (2024) | 123Movies™',
      'Посмотреть фильм Phir Aayi Hasseen Dillruba (2024) | 123Movies™',
      'مشاهدة فيلم Phir Aayi Hasseen Dillruba (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Phir Aayi Hasseen Dillruba (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-phir-aayi-hasseen-dillruba-2024'
  )
  return {
    props: {
      movie: selectedMovie
