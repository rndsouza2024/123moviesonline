...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Raayan (2024) | 123Movies™',
    alternateName: [
      'Ver película Raayan (2024) | 123Movies™',
      'Regarder le film Raayan (2024) | 123Movies™',
      'Film Raayan (2024) ansehen | 123Movies™',
      '观看电影 Raayan (2024) | 123Movies™',
      '映画 Raayan (2024) を見る | 123Movies™',
      '영화 Raayan (2024) 보기 | 123Movies™',
      'Assistir Filme Raayan (2024) | 123Movies™',
      'Guarda il film Raayan (2024) | 123Movies™',
      'Посмотреть фильм Raayan (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Raayan (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-raayan-2024'
  )
  return {
    props: {
      movie: selectedMovie
