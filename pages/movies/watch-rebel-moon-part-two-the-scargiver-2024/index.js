...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™',
    alternateName: [
      'Ver película Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™',
      'Regarder le film Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™',
      'Film Rebel Moon - Part Two: The Scargiver (2024) ansehen | 123Movies™',
      '观看电影 Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™',
      '映画 Rebel Moon - Part Two: The Scargiver (2024) を見る | 123Movies™',
      '영화 Rebel Moon - Part Two: The Scargiver (2024) 보기 | 123Movies™',
      'Assistir Filme Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™',
      'Guarda il film Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™',
      'Посмотреть фильм Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Rebel Moon - Part Two: The Scargiver (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-rebel-moon-part-two-the-scargiver-2024'
  )
  return {
    props: {
      movie: selectedMovie
