...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Revolver (2024) | 123Movies™',
    alternateName: [
      'Ver película Revolver (2024) | 123Movies™',
      'Regarder le film Revolver (2024) | 123Movies™',
      'Film Revolver (2024) ansehen | 123Movies™',
      '观看电影 Revolver (2024) | 123Movies™',
      '映画 Revolver (2024) を見る | 123Movies™',
      '영화 Revolver (2024) 보기 | 123Movies™',
      'Assistir Filme Revolver (2024) | 123Movies™',
      'Guarda il film Revolver (2024) | 123Movies™',
      'Посмотреть фильм Revolver (2024) | 123Movies™',
      'مشاهدة فيلم Revolver (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Revolver (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-revolver-2024'
  )
  return {
    props: {
      movie: selectedMovie
