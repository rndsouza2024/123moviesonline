...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Saindhav (2024) | 123Movies™',
    alternateName: [
      'Ver película Saindhav (2024) | 123Movies™',
      'Regarder le film Saindhav (2024) | 123Movies™',
      'Film Saindhav (2024) ansehen | 123Movies™',
      '观看电影 Saindhav (2024) | 123Movies™',
      '映画 Saindhav (2024) を見る | 123Movies™',
      '영화 Saindhav (2024) 보기 | 123Movies™',
      'Assistir Filme Saindhav (2024) | 123Movies™',
      'Guarda il film Saindhav (2024) | 123Movies™',
      'Посмотреть фильм Saindhav (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Saindhav (2024) | 123Movies™</title>
