...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Satyabhama (2024) | 123Movies™',
    alternateName: [
      'Ver película Satyabhama (2024) | 123Movies™',
      'Regarder le film Satyabhama (2024) | 123Movies™',
      'Film Satyabhama (2024) ansehen | 123Movies™',
      '观看电影 Satyabhama (2024) | 123Movies™',
      '映画 Satyabhama (2024) を見る | 123Movies™',
      '영화 Satyabhama (2024) 보기 | 123Movies™',
      'Assistir Filme Satyabhama (2024) | 123Movies™',
      'Guarda il film Satyabhama (2024) | 123Movies™',
      'Посмотреть фильм Satyabhama (2024) | 123Movies™',
      'مشاهدة فيلم Satyabhama (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Satyabhama (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-satyabhama-2024'
  )
  return {
    props: {
      movie: selectedMovie
