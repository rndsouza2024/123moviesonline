...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Shaitan (2024) | 123Movies™',
    alternateName: [
      'Ver película Shaitan (2024) | 123Movies™',
      'Regarder le film Shaitan (2024) | 123Movies™',
      'Film Shaitan (2024) ansehen | 123Movies™',
      '观看电影 Shaitan (2024) | 123Movies™',
      '映画 Shaitan (2024) を見る | 123Movies™',
      '영화 Shaitan (2024) 보기 | 123Movies™',
      'Assistir Filme Shaitan (2024) | 123Movies™',
      'Guarda il film Shaitan (2024) | 123Movies™',
      'Посмотреть фильм Shaitan (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Shaitan (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-shaitan-2024'
  )
  return {
    props: {
      movie: selectedMovie
