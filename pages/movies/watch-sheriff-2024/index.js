...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Sheriff (2024) | 123Movies™',
    alternateName: [
      'Ver película Sheriff (2024) | 123Movies™',
      'Regarder le film Sheriff (2024) | 123Movies™',
      'Film Sheriff (2024) ansehen | 123Movies™',
      '观看电影 Sheriff (2024) | 123Movies™',
      '映画 Sheriff (2024) を見る | 123Movies™',
      '영화 Sheriff (2024) 보기 | 123Movies™',
      'Assistir Filme Sheriff (2024) | 123Movies™',
      'Guarda il film Sheriff (2024) | 123Movies™',
      'Посмотреть фильм Sheriff (2024) | 123Movies™',
      'مشاهدة فيلم Sheriff (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Sheriff (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(movie => movie.id === 'watch-sheriff-2024')
  return {
    props: {
      movie: selectedMovie
    }
