...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Showtime (2024) | 123Movies™',
    alternateName: [
      'Ver película Showtime (2024) | 123Movies™',
      'Regarder le film Showtime (2024) | 123Movies™',
      'Film Showtime (2024) ansehen | 123Movies™',
      '观看电影 Showtime (2024) | 123Movies™',
      '映画 Showtime (2024) を見る | 123Movies™',
      '영화 Showtime (2024) 보기 | 123Movies™',
      'Assistir Filme Showtime (2024) | 123Movies™',
      'Guarda il film Showtime (2024) | 123Movies™',
      'Посмотреть фильм Showtime (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Showtime (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-showtime-2024'
  )
  return {
    props: {
      movie: selectedMovie
