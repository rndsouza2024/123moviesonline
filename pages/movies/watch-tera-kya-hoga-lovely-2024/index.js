...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Tera Kya Hoga Lovely (2024) | 123Movies™',
    alternateName: [
      'Ver película Tera Kya Hoga Lovely (2024) | 123Movies™',
      'Regarder le film Tera Kya Hoga Lovely (2024) | 123Movies™',
      'Film Tera Kya Hoga Lovely (2024) ansehen | 123Movies™',
      '观看电影 Tera Kya Hoga Lovely (2024) | 123Movies™',
      '映画 Tera Kya Hoga Lovely (2024) を見る | 123Movies™',
      '영화 Tera Kya Hoga Lovely (2024) 보기 | 123Movies™',
      'Assistir Filme Tera Kya Hoga Lovely (2024) | 123Movies™',
      'Guarda il film Tera Kya Hoga Lovely (2024) | 123Movies™',
      'Посмотреть фильм Tera Kya Hoga Lovely (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Tera Kya Hoga Lovely (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-tera-kya-hoga-lovely-2024'
  )
  return {
    props: {
      movie: selectedMovie
