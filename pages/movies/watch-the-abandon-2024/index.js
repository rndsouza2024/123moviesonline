...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Abandon (2024) | 123Movies™',
    alternateName: [
      'Ver película The Abandon (2024) | 123Movies™',
      'Regarder le film The Abandon (2024) | 123Movies™',
      'Film The Abandon (2024) ansehen | 123Movies™',
      '观看电影 The Abandon (2024) | 123Movies™',
      '映画 The Abandon (2024) を見る | 123Movies™',
      '영화 The Abandon (2024) 보기 | 123Movies™',
      'Assistir Filme The Abandon (2024) | 123Movies™',
      'Guarda il film The Abandon (2024) | 123Movies™',
      'Посмотреть фильм The Abandon (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Abandon (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-abandon-2024'
  )
  return {
    props: {
      movie: selectedMovie
