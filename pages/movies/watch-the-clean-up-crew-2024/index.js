...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Clean Up Crew (2024) | 123Movies™',
    alternateName: [
      'Ver película The Clean Up Crew (2024) | 123Movies™',
      'Regarder le film The Clean Up Crew (2024) | 123Movies™',
      'Film The Clean Up Crew (2024) ansehen | 123Movies™',
      '观看电影 The Clean Up Crew (2024) | 123Movies™',
      '映画 The Clean Up Crew (2024) を見る | 123Movies™',
      '영화 The Clean Up Crew (2024) 보기 | 123Movies™',
      'Assistir Filme The Clean Up Crew (2024) | 123Movies™',
      'Guarda il film The Clean Up Crew (2024) | 123Movies™',
      'Посмотреть фильм The Clean Up Crew (2024) | 123Movies™',
      'مشاهدة فيلم The Clean Up Crew (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Clean Up Crew (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-clean-up-crew-2024'
  )
  return {
    props: {
      movie: selectedMovie
