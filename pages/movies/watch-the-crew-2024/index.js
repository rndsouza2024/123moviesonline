...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Crew (2024) | 123Movies™',
    alternateName: [
      'Ver película Crew (2024) | 123Movies™',
      'Regarder le film Crew (2024) | 123Movies™',
      'Film Crew (2024) ansehen | 123Movies™',
      '观看电影 Crew (2024) | 123Movies™',
      '映画 Crew (2024) を見る | 123Movies™',
      '영화 Crew (2024) 보기 | 123Movies™',
      'Assistir Filme Crew (2024) | 123Movies™',
      'Guarda il film Crew (2024) | 123Movies™',
      'Посмотреть фильм Crew (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Crew (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-crew-2024'
  )
  return {
    props: {
      movie: selectedMovie
