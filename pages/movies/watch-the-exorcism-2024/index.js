...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Exorcism (2024) | 123Movies™',
    alternateName: [
      'Ver película The Exorcism (2024) | 123Movies™',
      'Regarder le film The Exorcism (2024) | 123Movies™',
      'Film The Exorcism (2024) ansehen | 123Movies™',
      '观看电影 The Exorcism (2024) | 123Movies™',
      '映画 The Exorcism (2024) を見る | 123Movies™',
      '영화 The Exorcism (2024) 보기 | 123Movies™',
      'Assistir Filme The Exorcism (2024) | 123Movies™',
      'Guarda il film The Exorcism (2024) | 123Movies™',
      'Посмотреть фильм The Exorcism (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Exorcism (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-exorcism-2024'
  )
  return {
    props: {
      movie: selectedMovie
