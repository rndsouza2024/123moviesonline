...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Family Star (2024) | 123Movies™',
    alternateName: [
      'Ver película The Family Star (2024) | 123Movies™',
      'Regarder le film The Family Star (2024) | 123Movies™',
      'Film The Family Star (2024) ansehen | 123Movies™',
      '观看电影 The Family Star (2024) | 123Movies™',
      '映画 The Family Star (2024) を見る | 123Movies™',
      '영화 The Family Star (2024) 보기 | 123Movies™',
      'Assistir Filme The Family Star (2024) | 123Movies™',
      'Guarda il film The Family Star (2024) | 123Movies™',
      'Посмотреть фильм The Family Star (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Family Star (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-family-star-2024'
  )
  return {
    props: {
      movie: selectedMovie
