...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Firing Squad (2024) | 123Movies™',
    alternateName: [
      'Ver película The Firing Squad (2024) | 123Movies™',
      'Regarder le film The Firing Squad (2024) | 123Movies™',
      'Film The Firing Squad (2024) ansehen | 123Movies™',
      '观看电影 The Firing Squad (2024) | 123Movies™',
      '映画 The Firing Squad (2024) を見る | 123Movies™',
      '영화 The Firing Squad (2024) 보기 | 123Movies™',
      'Assistir Filme The Firing Squad (2024) | 123Movies™',
      'Guarda il film The Firing Squad (2024) | 123Movies™',
      'Посмотреть фильм The Firing Squad (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Firing Squad (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-firing-squad-2024'
  )
  return {
    props: {
      movie: selectedMovie
