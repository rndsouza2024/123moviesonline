...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Girl in the Trunk (2024) | 123Movies™',
    alternateName: [
      'Ver película The Girl in the Trunk (2024) | 123Movies™',
      'Regarder le film The Girl in the Trunk (2024) | 123Movies™',
      'Film The Girl in the Trunk (2024) ansehen | 123Movies™',
      '观看电影 The Girl in the Trunk (2024) | 123Movies™',
      '映画 The Girl in the Trunk (2024) を見る | 123Movies™',
      '영화 The Girl in the Trunk (2024) 보기 | 123Movies™',
      'Assistir Filme The Girl in the Trunk (2024) | 123Movies™',
      'Guarda il film The Girl in the Trunk (2024) | 123Movies™',
      'Посмотреть фильм The Girl in the Trunk (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Girl in the Trunk (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-girl-in-the-trunk-2024'
  )
  return {
    props: {
      movie: selectedMovie
