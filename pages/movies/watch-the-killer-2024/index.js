...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Killer (2024) | 123Movies™',
    alternateName: [
      'Ver película The Killer (2024) | 123Movies™',
      'Regarder le film The Killer (2024) | 123Movies™',
      'Film The Killer (2024) ansehen | 123Movies™',
      '观看电影 The Killer (2024) | 123Movies™',
      '映画 The Killer (2024) を見る | 123Movies™',
      '영화 The Killer (2024) 보기 | 123Movies™',
      'Assistir Filme The Killer (2024) | 123Movies™',
      'Guarda il film The Killer (2024) | 123Movies™',
      'Посмотреть фильм The Killer (2024) | 123Movies™',
      'مشاهدة فيلم The Killer (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Killer (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-killer-2024'
  )
  return {
    props: {
      movie: selectedMovie
