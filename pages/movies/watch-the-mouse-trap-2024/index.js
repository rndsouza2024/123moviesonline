...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Mouse Trap (2024) | 123Movies™',
    alternateName: [
      'Ver película The Mouse Trap (2024) | 123Movies™',
      'Regarder le film The Mouse Trap (2024) | 123Movies™',
      'Film The Mouse Trap (2024) ansehen | 123Movies™',
      '观看电影 The Mouse Trap (2024) | 123Movies™',
      '映画 The Mouse Trap (2024) を見る | 123Movies™',
      '영화 The Mouse Trap (2024) 보기 | 123Movies™',
      'Assistir Filme The Mouse Trap (2024) | 123Movies™',
      'Guarda il film The Mouse Trap (2024) | 123Movies™',
      'Посмотреть фильм The Mouse Trap (2024) | 123Movies™',
      'مشاهدة فيلم The Mouse Trap (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Mouse Trap (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-mouse-trap-2024'
  )
  return {
    props: {
      movie: selectedMovie
