...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie The Union (2024) | 123Movies™',
    alternateName: [
      'Ver película The Union (2024) | 123Movies™',
      'Regarder le film The Union (2024) | 123Movies™',
      'Film The Union (2024) ansehen | 123Movies™',
      '观看电影 The Union (2024) | 123Movies™',
      '映画 The Union (2024) を見る | 123Movies™',
      '영화 The Union (2024) 보기 | 123Movies™',
      'Assistir Filme The Union (2024) | 123Movies™',
      'Guarda il film The Union (2024) | 123Movies™',
      'Посмотреть фильм The Union (2024) | 123Movies™',
      'مشاهدة فيلم The Union (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie The Union (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-the-union-2024'
  )
  return {
    props: {
      movie: selectedMovie
