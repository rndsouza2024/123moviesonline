...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Trap (2024) | 123Movies™',
    alternateName: [
      'Ver película Trap (2024) | 123Movies™',
      'Regarder le film Trap (2024) | 123Movies™',
      'Film Trap (2024) ansehen | 123Movies™',
      '观看电影 Trap (2024) | 123Movies™',
      '映画 Trap (2024) を見る | 123Movies™',
      '영화 Trap (2024) 보기 | 123Movies™',
      'Assistir Filme Trap (2024) | 123Movies™',
      'Guarda il film Trap (2024) | 123Movies™',
      'Посмотреть фильм Trap (2024) | 123Movies™',
      'مشاهدة فيلم Trap (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Trap (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-trap-2024'
  )
  return {
    props: {
      movie: selectedMovie
