...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Trigger Warning (2024) | 123Movies™',
    alternateName: [
      'Ver película Trigger Warning (2024) | 123Movies™',
      'Regarder le film Trigger Warning (2024) | 123Movies™',
      'Film Trigger Warning (2024) ansehen | 123Movies™',
      '观看电影 Trigger Warning (2024) | 123Movies™',
      '映画 Trigger Warning (2024) を見る | 123Movies™',
      '영화 Trigger Warning (2024) 보기 | 123Movies™',
      'Assistir Filme Trigger Warning (2024) | 123Movies™',
      'Guarda il film Trigger Warning (2024) | 123Movies™',
      'Посмотреть фильм Trigger Warning (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Trigger Warning (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-trigger-warning-2024'
  )
  return {
    props: {
      movie: selectedMovie
