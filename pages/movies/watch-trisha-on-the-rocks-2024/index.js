...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Trisha on the Rocks (2024) | 123Movies™',
    alternateName: [
      'Ver película Trisha on the Rocks (2024) | 123Movies™',
      'Regarder le film Trisha on the Rocks (2024) | 123Movies™',
      'Film Trisha on the Rocks (2024) ansehen | 123Movies™',
      '观看电影 Trisha on the Rocks (2024) | 123Movies™',
      '映画 Trisha on the Rocks (2024) を見る | 123Movies™',
      '영화 Trisha on the Rocks (2024) 보기 | 123Movies™',
      'Assistir Filme Trisha on the Rocks (2024) | 123Movies™',
      'Guarda il film Trisha on the Rocks (2024) | 123Movies™',
      'Посмотреть фильм Trisha on the Rocks (2024) | 123Movies™',
      'مشاهدة فيلم Trisha on the Rocks (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Trisha on the Rocks (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-trisha-on-the-rocks-2024'
  )
  return {
    props: {
      movie: selectedMovie
