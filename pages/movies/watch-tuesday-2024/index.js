...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Tuesday (2024) | 123Movies™',
    alternateName: [
      'Ver película Tuesday (2024) | 123Movies™',
      'Regarder le film Tuesday (2024) | 123Movies™',
      'Film Tuesday (2024) ansehen | 123Movies™',
      '观看电影 Tuesday (2024) | 123Movies™',
      '映画 Tuesday (2024) を見る | 123Movies™',
      '영화 Tuesday (2024) 보기 | 123Movies™',
      'Assistir Filme Tuesday (2024) | 123Movies™',
      'Guarda il film Tuesday (2024) | 123Movies™',
      'Посмотреть фильм Tuesday (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Tuesday (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-tuesday-2024'
  )
  return {
    props: {
      movie: selectedMovie
