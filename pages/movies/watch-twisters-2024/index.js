...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Twisters (2024) | 123Movies™',
    alternateName: [
      'Ver película Twisters (2024) | 123Movies™',
      'Regarder le film Twisters (2024) | 123Movies™',
      'Film Twisters (2024) ansehen | 123Movies™',
      '观看电影 Twisters (2024) | 123Movies™',
      '映画 Twisters (2024) を見る | 123Movies™',
      '영화 Twisters (2024) 보기 | 123Movies™',
      'Assistir Filme Twisters (2024) | 123Movies™',
      'Guarda il film Twisters (2024) | 123Movies™',
      'Посмотреть фильм Twisters (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Twisters (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-twisters-2024'
  )
  return {
    props: {
      movie: selectedMovie
