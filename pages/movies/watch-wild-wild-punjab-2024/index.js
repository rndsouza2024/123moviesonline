...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Wild Wild Punjab (2024) | 123Movies™',
    alternateName: [
      'Ver película Wild Wild Punjab (2024) | 123Movies™',
      'Regarder le film Wild Wild Punjab (2024) | 123Movies™',
      'Film Wild Wild Punjab (2024) ansehen | 123Movies™',
      '观看电影 Wild Wild Punjab (2024) | 123Movies™',
      '映画 Wild Wild Punjab (2024) を見る | 123Movies™',
      '영화 Wild Wild Punjab (2024) 보기 | 123Movies™',
      'Assistir Filme Wild Wild Punjab (2024) | 123Movies™',
      'Guarda il film Wild Wild Punjab (2024) | 123Movies™',
      'Посмотреть фильм Wild Wild Punjab (2024) | 123Movies™',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Wild Wild Punjab (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-wild-wild-punjab-2024'
  )
  return {
    props: {
      movie: selectedMovie
