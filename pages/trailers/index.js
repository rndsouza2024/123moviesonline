...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online Trailers | 123Movies™',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Trailers',
      item: 'https://123moviesonline.vercel.app/trailers/'
    }
  ]
})
...
const trailersPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Latest Trailers | 123Movies™</title>
        <link rel='canonical' href='https://123moviesonline.vercel.app/trailers/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Latest Trailers | 123Movies™' />
       ...
       <meta name="description" content="Stream HD movies and TV series for free on 123Movies Online. Explore, stream, and download full-length movies and shows in HD quality without registration."/>
        ...
        <meta property='og:url' content='https://123moviesonline.vercel.app/trailers' />
 ...
 <SocialSharing />
      ...
      {/* <Script src='../propler/ads2.js' defer /> */} 
        ...
        >
          123Movies Online™ - Trailers Section.
        </h1>
