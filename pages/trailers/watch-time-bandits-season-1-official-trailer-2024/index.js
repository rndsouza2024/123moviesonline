...
const trailersDetail = ({ trailers }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://123moviesonline.vercel.app/trailers.json')
    ...
    const linkTargets = [
      {
        text: 'Time Bandits Season 1 - 2024',
          url: `https://www.imdb.com/title/${trailers.idbm}/`
      }
    ]
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        headline: ` ${trailers.name} | 123Movies™`,
        datePublished: trailers.datePublished,
        dateModified: trailers.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Time Bandits Season 1 Official Trailer | 123Movies™</title>
        ...
        <meta
          property='og:title'
          content={`${trailers && trailers.name} - 123Movies™`}
        />
        <meta
        ...
        <meta
          ...
          content='Stream HD movies and TV series for free on 123Movies Online™. Explore, stream, and download full-length movies and shows in HD quality without registration.'
        />
        <meta name='twitter:image' content={`${trailers && trailers.image1}`} />
      ...
      >
        ...
        <div className='flex-container'>
          <div className='category-container'>
            ...
            >
              <h2 className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent  hover:text-blue-800 text-bg font-semibold mt-2'>
            ...
            <h2 className='px-0 bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent  hover:text-blue-800 text-bg font-semibold mt-2'>
              ...
              <div className=' bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent  hover:text-blue-800 text-bg font-semibold mt-2'>
                ...
                {trailers.news1 &&
                  trailers.news1.split('\n\n').map((paragraph, idx) => (
                    <p
                      key={idx}
                      className='description bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent  hover:text-blue-800 text-bg font-semibold mt-2'
                      style={{
                        marginBottom: '10px',
                        fontFamily: 'Poppins, sans-serif'
                      }}
              ...
              >
                ...
                >
                  ...
                  <meta itemprop='description' content={trailers.text} />
                  <meta
                    itemprop='uploadDate'
                    content={trailers.datePublished}
                  />
                  <meta itemprop='thumbnailUrl' content={trailers.backimage} />
                  <meta itemprop='duration' content='P34S' />
                  <meta itemprop='embedUrl' content={trailers.videourl} />
                </div>
                <iframe
                  frameborder='0'
                    ...
                    <a href={trailer['trailers.watch']} id={trailer.id}>
                      <div className='relative'>
                       ...
                       <h2 className='bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-xl font-semibold mt-2'>
                        ...
                        <div className='bg-gradient-to-r from-pink-700 to-blue-700 bg-clip-text text-transparent text-bg font-semibold mt-2'>
                          {trailer.text}
                        </div>
                      </div>
                    </a>
...
export async function getServerSideProps () {
  const res = await fetch('https://123moviesonline.vercel.app/trailers.json')
