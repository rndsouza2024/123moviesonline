  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${tvshowzipItem.name} | 123 Movies???`,
      ...
      },
      {
        ...
        headline: ` ${tvshowzipItem.name} | 123 Movies???`,
        datePublished: tvshowzipItem.datePublished,
        dateModified: tvshowzipItem.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {tvshowzipItem.name} | 123 Movies???</title>
        ...
        <meta
          property='og:title'
          content={`${tvshowzipItem && tvshowzipItem.name} - 123 Movies???`}
        />
        <meta
          property='og:description'
          content='Stream HD tvshowzipItems and TV series for free on 123 Movies???. Online. Stream. Download. full-length tvshowzipItems and shows in HD quality without registration.'
        />
        <meta
          name='description'
          content={`${tvshowzipItem.title} available on 123 Movies???. Enjoy free streaming of full-length tvshowzipItems and TV series online with no registration required.`}
        />
        <meta
          property='og:url'
