...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online Tvshow | 123Movies™',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Tvshow',
      item: 'https://123moviesonline.vercel.app/tvshow/'
    }
  ]
})
...
const tvshowPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Onile Tvshow | 123Movies™</title>
        ...
        <meta property='og:title' content=' Watch Online Tvshow | 123Movies™' />
      ...
      >
        123Movies Online™ - TV Series Section.
      </h1>
