...
const TvshowPage = ({ tvshows }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    '@type': 'WebPage',
    url: 'https://123moviesonline.vercel.app/tvshow',
    name: '123Movies Online™ - TV Show',
    alternateName: [
      '123Movies Online™ - Programa de TV',
      '123Movies Online™ - Émission de télévision',
      '123Movies Online™ - Fernsehsendung',
      '123Movies Online™ - 电视节目',
      '123Movies Online™ - テレビ番組',
      '123Movies Online™ - TV 쇼',
      '123Movies Online™ - Programa de TV',
      '123Movies Online™ - Programma TV',
      '123Movies Online™ - Телепередача',
      '123Movies Online™ - برنامج تلفزيوني'
    ],
    inLanguage: [
