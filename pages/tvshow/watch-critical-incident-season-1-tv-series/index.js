...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Critical Incident Season 1 (2024) | 123Movies™',
    alternateName: [
      'Ver película Critical Incident Season 1 (2024) | 123Movies™',
      'Regarder le film Critical Incident Season 1 (2024) | 123Movies™',
      'Film Critical Incident Season 1 (2024) ansehen | 123Movies™',
      '观看电影 Critical Incident Season 1 (2024) | 123Movies™',
      '映画 Critical Incident Season 1 (2024) を見る | 123Movies™',
      '영화 Critical Incident Season 1 (2024) 보기 | 123Movies™',
      'Assistir Filme Critical Incident Season 1 (2024) | 123Movies™',
      'Guarda il film Critical Incident Season 1 (2024) | 123Movies™',
      'Посмотреть фильм Critical Incident Season 1 (2024) | 123Movies™',
      'مشاهدة فيلم Critical Incident Season 1 (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Critical Incident Season 1 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-critical-incident-season-1-tv-series'
  )
  return {
    props: {
      movie: selectedMovie
