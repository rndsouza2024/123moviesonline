...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Fake Season 1 (2024) | 123Movies™',
    alternateName: [
      'Fake Temporada 1 (2024) | 123Movies™', // Spanish
      'Fake Saison 1 (2024) | 123Movies™', // French
      'Fake Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Fake Temporada 1 (2024) | 123Movies™', // Portuguese
      'Fake Stagione 1 (2024) | 123Movies™', // Italian
      'Fake Сезон 1 (2024) | 123Movies™', // Russian
      'Fake الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Fake Season 1 (2024) | 123Movies™</title>
