...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Fringe Season 4 (2024) | 123Movies™',
    alternateName: [
      'Fringe Temporada 4 (2024) | 123Movies™', // Spanish
      'Fringe Saison 4 (2024) | 123Movies™', // French
      'Fringe Staffel 4 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 4 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 4 (2024) | 123Movies™', // Korean
      'Fringe Temporada 4 (2024) | 123Movies™', // Portuguese
      'Fringe Stagione 4 (2024) | 123Movies™', // Italian
      'Fringe Сезон 4 (2024) | 123Movies™', // Russian
      'Fringe الموسم43 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Fringe Season 4 (2024) | 123Movies™</title>
