...
const tvshowDetail = ({ tvshow }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        'https://123moviesonline.vercel.app/tvshowfinal.json'
      )
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Heeramandi: The Diamond Bazaar Season 1 (2024) | 123Movies™',
    alternateName: [
      'Heeramandi: The Diamond Bazaar Temporada 1 (2024) | 123Movies™', // Spanish
      'Heeramandi: The Diamond Bazaar Saison 1 (2024) | 123Movies™', // French
      'Heeramandi: The Diamond Bazaar Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Heeramandi: The Diamond Bazaar Temporada 1 (2024) | 123Movies™', // Portuguese
      'Heeramandi: The Diamond Bazaar Stagione 1 (2024) | 123Movies™', // Italian
      'Heeramandi: The Diamond Bazaar Сезон 1 (2024) | 123Movies™', // Russian
      'Heeramandi: The Diamond Bazaar الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Heeramandi: The Diamond Bazaar Season 1 (2024) | 123Movies™</title>
