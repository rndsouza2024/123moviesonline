...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Hierarchy Season 1 (2024) | 123Movies™',
    alternateName: [
      'Hierarchy Temporada 1 (2024) | 123Movies™', // Spanish
      'Hierarchy Saison 1 (2024) | 123Movies™', // French
      'Hierarchy Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Hierarchy Temporada 1 (2024) | 123Movies™', // Portuguese
      'Hierarchy Stagione 1 (2024) | 123Movies™', // Italian
      'Hierarchy Сезон 1 (2024) | 123Movies™', // Russian
      'Hierarchy الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Hierarchy Season 1 (2024) | 123Movies™</title>
