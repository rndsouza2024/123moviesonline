...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Hierarchy Season 1 (2024) | 123Movies™',
    alternateName: [
      'Ver película Hierarchy Season 1 (2024) | 123Movies™',
      'Regarder le film Hierarchy Season 1 (2024) | 123Movies™',
      'Film Hierarchy Season 1 (2024) ansehen | 123Movies™',
      '观看电影 Hierarchy Season 1 (2024) | 123Movies™',
      '映画 Hierarchy Season 1 (2024) を見る | 123Movies™',
      '영화 Hierarchy Season 1 (2024) 보기 | 123Movies™',
      'Assistir Filme Hierarchy Season 1 (2024) | 123Movies™',
      'Guarda il film Hierarchy Season 1 (2024) | 123Movies™',
      'Посмотреть фильм Hierarchy Season 1 (2024) | 123Movies™',
      'مشاهدة فيلم Hierarchy Season 1 (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Hierarchy Season 1 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-hierarchy-season-1-tv-series'
  )
  return {
    props: {
      movie: selectedMovie
