...
const tvshowDetail = ({ tvshow }) => {
  ...
  const enhancedParagraph = text => {
    const linkTargets = [
      {
        text: 'Life Hill Gayi Season 1 - 2024',
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Life Hill Gayi Season 1 (2024) | 123Movies™',
    alternateName: [
      'Life Hill Gayi Temporada 1 (2024) | 123Movies™', // Spanish
      'Life Hill Gayi Saison 1 (2024) | 123Movies™', // French
      'Life Hill Gayi Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Life Hill Gayi Temporada 1 (2024) | 123Movies™', // Portuguese
      'Life Hill Gayi Stagione 1 (2024) | 123Movies™', // Italian
      'Life Hill Gayi Сезон 1 (2024) | 123Movies™', // Russian
      'Life Hill Gayi الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Life Hill Gayi Season 1 (2024) | 123Movies™</title>
