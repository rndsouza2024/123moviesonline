...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    url: 'https://123moviesonline.vercel.app/tvshow/watch-Life Hill Gayi-season-1-tv-series',
    name: 'Watch Life Hill Gayi (2020) | 123Movies™',
    alternateName: [
      'Ver Life Hill Gayi Temporada 1 (2024) | 123Movies™',
      'Regarder Life Hill Gayi Saison 1 (2024) | 123Movies™',
      'Life Hill Gayi Staffel 1 (2024) ansehen | 123Movies™',
      '观看黑暗物质 第一季 (2024) | 123Movies™',
      'ダークマター シーズン 1 (2024) を見る | 123Movies™',
      '다크 매터 시즌 1 (2024) 보기 | 123Movies™',
      'Assistir Life Hill Gayi Temporada 1 (2024) | 123Movies™',
      'Guarda Life Hill Gayi Stagione 1 (2024) | 123Movies™',
      'Посмотреть Life Hill Gayi Сезон 1 (2024) | 123Movies™',
      'مشاهدة Life Hill Gayi الموسم 1 (2024) | جِي دبليو إف™'
    ],
    inLanguage: [
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Life Hill Gayi (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedTvshow = data.find(tvshow => tvshow.id === 'INDEX34')
  return {
    props: {
