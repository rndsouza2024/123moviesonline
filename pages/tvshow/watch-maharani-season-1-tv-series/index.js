...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Maharani Season 1 (2024) | 123Movies™',
    alternateName: [
      'Maharani Temporada 1 (2024) | 123Movies™', // Spanish
      'Maharani Saison 1 (2024) | 123Movies™', // French
      'Maharani Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Maharani Temporada 1 (2024) | 123Movies™', // Portuguese
      'Maharani Stagione 1 (2024) | 123Movies™', // Italian
      'Maharani Сезон 1 (2024) | 123Movies™', // Russian
      'Maharani الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
