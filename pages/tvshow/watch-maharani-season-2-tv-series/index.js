...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Maharani Season 2 (2024) | 123Movies™',
    alternateName: [
      'Maharani Temporada 2 (2024) | 123Movies™', // Spanish
      'Maharani Saison 2 (2024) | 123Movies™', // French
      'Maharani Staffel 2 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 2 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 2 (2024) | 123Movies™', // Korean
      'Maharani Temporada 2 (2024) | 123Movies™', // Portuguese
      'Maharani Stagione 2 (2024) | 123Movies™', // Italian
      'Maharani Сезон 2 (2024) | 123Movies™', // Russian
      'Maharani الموسم 2 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Maharani Season 2 (2024) | 123Movies™</title>
