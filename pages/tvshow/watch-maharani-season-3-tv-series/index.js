...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Maharani Season 3 (2024) | 123Movies™',
    alternateName: [
      'Maharani Temporada 3 (2024) | 123Movies™', // Spanish
      'Maharani Saison 3 (2024) | 123Movies™', // French
      'Maharani Staffel 3 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 3 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 3 (2024) | 123Movies™', // Korean
      'Maharani Temporada 3 (2024) | 123Movies™', // Portuguese
      'Maharani Stagione 3 (2024) | 123Movies™', // Italian
      'Maharani Сезон 3 (2024) | 123Movies™', // Russian
      'Maharani الموسم 3 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
              ...
              <div className='flex flex-col items-center justify-center'>
                ...
                {tvshow.linkurl && (
                  <Link href={tvshow.linkurl}>
                    ...
                    >
                      Click to Watch Previous Season 2
                    </div>
                  </Link>
                )}
              </div>
