...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Passenger Season 1 (2024) | 123Movies™',
    alternateName: [
      'Passenger Temporada 1 (2024) | 123Movies™', // Spanish
      'Passenger Saison 1 (2024) | 123Movies™', // French
      'Passenger Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Passenger Temporada 1 (2024) | 123Movies™', // Portuguese
      'Passenger Stagione 1 (2024) | 123Movies™', // Italian
      'Passenger Сезон 1 (2024) | 123Movies™', // Russian
      'Passenger الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
