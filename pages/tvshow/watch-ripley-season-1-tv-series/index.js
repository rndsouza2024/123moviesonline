...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Ripley Season 1 (2024) | 123Movies™',
    alternateName: [
      'Ripley Temporada 1 (2024) | 123Movies™', // Spanish
      'Ripley Saison 1 (2024) | 123Movies™', // French
      'Ripley Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Ripley Temporada 1 (2024) | 123Movies™', // Portuguese
      'Ripley Stagione 1 (2024) | 123Movies™', // Italian
      'Ripley Сезон 1 (2024) | 123Movies™', // Russian
      'Ripley الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Ripley Season 1 (2024) | 123Movies™</title>
