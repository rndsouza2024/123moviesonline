...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Ripley Season 1 (2024) | 123Movies™',
    alternateName: [
      'Ver película Ripley Season 1 (2024) | 123Movies™',
      'Regarder le film Ripley Season 1 (2024) | 123Movies™',
      'Film Ripley Season 1 (2024) ansehen | 123Movies™',
      '观看电影 Ripley Season 1 (2024) | 123Movies™',
      '映画 Ripley Season 1 (2024) を見る | 123Movies™',
      '영화 Ripley Season 1 (2024) 보기 | 123Movies™',
      'Assistir Filme Ripley Season 1 (2024) | 123Movies™',
      'Guarda il film Ripley Season 1 (2024) | 123Movies™',
      'Посмотреть фильм Ripley Season 1 (2024) | 123Movies™',
      'مشاهدة فيلم Ripley Season 1 (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Ripley Season 1 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-ripley-season-1-tv-series'
  )
  return {
    props: {
      movie: selectedMovie
