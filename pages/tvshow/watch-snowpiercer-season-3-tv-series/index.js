...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Snowpiercer Season 3 (2024) | 123Movies™',
    alternateName: [
      'Snowpiercer Temporada 3 (2024) | 123Movies™', // Spanish
      'Snowpiercer Saison 3 (2024) | 123Movies™', // French
      'Snowpiercer Staffel 3 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 3 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 3 (2024) | 123Movies™', // Korean
      'Snowpiercer Temporada 3 (2024) | 123Movies™', // Portuguese
      'Snowpiercer Stagione 3 (2024) | 123Movies™', // Italian
      'Snowpiercer Сезон 3 (2024) | 123Movies™', // Russian
      'Snowpiercer الموسم 3 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Snowpiercer Season 3 (2024) | 123Movies™</title>
