...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Snowpiercer Season 4 (2024) | 123Movies™',
    alternateName: [
      'Snowpiercer Temporada 4 (2024) | 123Movies™', // Spanish
      'Snowpiercer Saison 4 (2024) | 123Movies™', // French
      'Snowpiercer Staffel 4 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 4 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 4 (2024) | 123Movies™', // Korean
      'Snowpiercer Temporada 4 (2024) | 123Movies™', // Portuguese
      'Snowpiercer Stagione 4 (2024) | 123Movies™', // Italian
      'Snowpiercer Сезон 4 (2024) | 123Movies™', // Russian
      'Snowpiercer الموسم43 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Snowpiercer Season 4 (2024) | 123Movies™</title>
              ...
              <div className='flex flex-col items-center justify-center'>
                ...
                {tvshow.linkurl && (
                  <Link href={tvshow.linkurl}>
                    ...
                    >
                      Click to Watch Previous Season 3
                    </div>
                  </Link>
                )}
              </div>
