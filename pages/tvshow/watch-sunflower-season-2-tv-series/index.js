...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Sunflower Season 2 (2024) | 123Movies™',
    alternateName: [
      'Sunflower Temporada 2 (2024) | 123Movies™', // Spanish
      'Sunflower Saison 2 (2024) | 123Movies™', // French
      'Sunflower Staffel 2 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 2 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 2 (2024) | 123Movies™', // Korean
      'Sunflower Temporada 2 (2024) | 123Movies™', // Portuguese
      'Sunflower Stagione 2 (2024) | 123Movies™', // Italian
      'Sunflower Сезон 2 (2024) | 123Movies™', // Russian
      'Sunflower الموسم 2 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Sunflower Season 2 (2024) | 123Movies™</title>
