...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'The Acolyte Season 1 (2024) | 123Movies™',
    alternateName: [
      'The Acolyte Temporada 1 (2024) | 123Movies™', // Spanish
      'The Acolyte Saison 1 (2024) | 123Movies™', // French
      'The Acolyte Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'The Acolyte Temporada 1 (2024) | 123Movies™', // Portuguese
      'The Acolyte Stagione 1 (2024) | 123Movies™', // Italian
      'The Acolyte Сезон 1 (2024) | 123Movies™', // Russian
      'The Acolyte الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch The Acolyte Season 1 (2024) | 123Movies™</title>
