...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Time Bandits Season 1 (2024) | 123Movies™',
    alternateName: [
      'Time Bandits Temporada 1 (2024) | 123Movies™', // Spanish
      'Time Bandits Saison 1 (2024) | 123Movies™', // French
      'Time Bandits Staffel 1 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 1 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 1 (2024) | 123Movies™', // Korean
      'Time Bandits Temporada 1 (2024) | 123Movies™', // Portuguese
      'Time Bandits Stagione 1 (2024) | 123Movies™', // Italian
      'Time Bandits Сезон 1 (2024) | 123Movies™', // Russian
      'Time Bandits الموسم 1 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Time Bandits Season 1 (2024) | 123Movies™</title>
