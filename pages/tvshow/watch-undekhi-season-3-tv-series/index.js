...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Undekhi Season 3 (2024) | 123Movies™',
    alternateName: [
      'Undekhi Temporada 3 (2024) | 123Movies™', // Spanish
      'Undekhi Saison 3 (2024) | 123Movies™', // French
      'Undekhi Staffel 3 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 3 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 3 (2024) | 123Movies™', // Korean
      'Undekhi Temporada 3 (2024) | 123Movies™', // Portuguese
      'Undekhi Stagione 3 (2024) | 123Movies™', // Italian
      'Undekhi Сезон 3 (2024) | 123Movies™', // Russian
      'Undekhi الموسم 3 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Undekhi Season 3 (2024) | 123Movies™</title>
