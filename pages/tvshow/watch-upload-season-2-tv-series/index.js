...
const tvshowDetail = ({ tvshow }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Upload Season 2 (2024) | 123Movies™',
    alternateName: [
      'Upload Temporada 2 (2024) | 123Movies™', // Spanish
      'Upload Saison 2 (2024) | 123Movies™', // French
      'Upload Staffel 2 (2024) | 123Movies™', // German
      '黑暗物质 第一季 (2024) | 123Movies™', // Simplified Chinese
      'ダークマター シーズン 2 (2024) | 123Movies™', // Japanese
      '다크 매터 시즌 2 (2024) | 123Movies™', // Korean
      'Upload Temporada 2 (2024) | 123Movies™', // Portuguese
      'Upload Stagione 2 (2024) | 123Movies™', // Italian
      'Upload Сезон 2 (2024) | 123Movies™', // Russian
      'Upload الموسم 2 (2024) | جِي دبليو إف™' // Arabic
    ],
    inLanguage: [
      'es', // Spanish
      'fr', // French
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Upload Season 2 (2024) | 123Movies™</title>
