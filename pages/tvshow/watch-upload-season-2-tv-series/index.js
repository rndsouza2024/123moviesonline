...
const moviesDetail = ({ movie }) => {
  ...
  const languagesSchema = JSON.stringify({
    ...
    name: 'Watch Movie Upload Season 2 (2024) | 123Movies™',
    alternateName: [
      'Ver película Upload Season 2 (2024) | 123Movies™',
      'Regarder le film Upload Season 2 (2024) | 123Movies™',
      'Film Upload Season 2 (2024) ansehen | 123Movies™',
      '观看电影 Upload Season 2 (2024) | 123Movies™',
      '映画 Upload Season 2 (2024) を見る | 123Movies™',
      '영화 Upload Season 2 (2024) 보기 | 123Movies™',
      'Assistir Filme Upload Season 2 (2024) | 123Movies™',
      'Guarda il film Upload Season 2 (2024) | 123Movies™',
      'Посмотреть фильм Upload Season 2 (2024) | 123Movies™',
      'مشاهدة فيلم Upload Season 2 (2024) | جي دبليو إف™'
    ],
    inLanguage: [
      'es',
      'fr',
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Upload Season 2 (2024) | 123Movies™</title>
...
export async function getServerSideProps () {
  ...
  const selectedMovie = data.find(
    movie => movie.id === 'watch-upload-season-2-tv-series'
  )
  return {
    props: {
      movie: selectedMovie
